		...
		<div class="h-100">
			...
			<div class="error-page d-flex align-items-center">
				<div class="content-wrapper">
					<h6>500</h6>
					<h1 class="font-recoleta">Internal Server Error </h1>
					<p class="text-lg">Publishing industries for previewing layouts & <br> visual mockups used.</p>
					<a href="{{ url('home.index') }}" class="theme-btn-four">GO BACK</a>
				</div> <!-- /.content-wrapper -->
				<img src="{{ URL::asset('images/assets/ils_07.png') }}" alt="" class="shapes illustration">
			</div> <!-- /.error-page -->
