...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
				...
				<div class="container">
					<div class="row">
						<div class="col-lg-5 col-md-6">
							<h2 class="page-title font-recoleta">Our <span>Inside</span> News.</h2>
						</div>
			...
			=====================================================
			-->
			<div class="blog-section-four dark-bg mb-70 lg-mb-50">
				<div class="container">
							...
							<div class="blog-meta-wrapper">
								<article class="blog-meta-four">
									...
									<div class="post-footer d-flex align-items-center justify-content-between">
										<img src="{{ URL::asset('images/blog/logo_09.png') }}" alt="" class="logo">
										<a href="{{ url('blog.blog-detailsV3') }}" class="read-more tran3s"><img src="{{ URL::asset('images/icon/icon_65.svg') }}" alt=""></a>
									</div>
								...
								<article class="blog-meta-four">
									...
									<div class="post-footer d-flex align-items-center justify-content-between">
										<img src="{{ URL::asset('images/blog/logo_10.png') }}" alt="" class="logo">
										<a href="{{ url('blog.blog-detailsV3') }}" class="read-more tran3s"><img src="{{ URL::asset('images/icon/icon_65.svg') }}" alt=""></a>
									</div>
								</article> <!-- /.blog-meta-four -->
								<article class="blog-meta-four">
									<div class="img-meta position-relative">
										<img src="{{ URL::asset('images/blog/blog_img_08.jpg') }}" alt="" class="w-100">
										<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
									</div>
									<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
									<a href="{{ url('blog.blog-detailsV3') }}" class="title">Medieval origins to the digital era, learn everything there is to know. </a>
									<div class="post-footer d-flex align-items-center justify-content-between">
										<img src="{{ URL::asset('images/blog/logo_09.png') }}" alt="" class="logo">
										<a href="{{ url('blog.blog-detailsV3') }}" class="read-more tran3s"><img src="{{ URL::asset('images/icon/icon_65.svg') }}" alt=""></a>
									</div>
								...
								<article class="blog-meta-four">
									<div class="img-meta position-relative">
										<img src="{{ URL::asset('images/blog/blog_img_07.jpg') }}" alt="" class="w-100">
										<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
									</div>
									<div class="post-info">Solution, Design - <span class="date">18 Jul 20</span></div>
									<a href="{{ url('blog.blog-detailsV3') }}" class="title">Print, publishing qui visual ux layout mockups.</a>
									<div class="post-footer d-flex align-items-center justify-content-between">
										<img src="{{ URL::asset('images/blog/logo_09.png') }}" alt="" class="logo">
										<a href="{{ url('blog.blog-detailsV3') }}" class="read-more tran3s"><img src="{{ URL::asset('images/icon/icon_65.svg') }}" alt=""></a>
								...
								<article class="blog-meta-four">
									<div class="img-meta position-relative">
										<img src="{{ URL::asset('images/blog/blog_img_09.jpg') }}" alt="" class="w-100">
										<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
									</div>
									<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
									<a href="{{ url('blog.blog-detailsV3') }}" class="title">Print, publishing qui visual ux layout mockups.</a>
