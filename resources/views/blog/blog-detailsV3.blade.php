	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-eight text-center">
				<div class="container">
					<p class="blog-pubish-date">Digital Marketing . 2 July 2021 . By <a href="#">Rashed Ka</a></p>
					<div class="row">
						<div class="col-xxl-8 col-xl-9 col-lg-8 m-auto">
							<h2 class="blog-heading-two">Creativo Para Jóvenes: a Designer’s UI/UX Complete Checklist.</h2>
						</div>
					</div>
					<nav class="blog-breadcrumb mt-70 lg-mt-30">
						<ol class="breadcrumb justify-content-center">
						    <li class="breadcrumb-item"><a href="{{ url('home.index') }}">Home</a></li>
						    <li class="breadcrumb-item"><a href="{{ url('blog.blogV1') }}">Personal</a></li>
						...
						<div class="col-xl-10 m-auto">
							<div class="blog-meta-wrapper pe-xxl-5 ps-xxl-5">
								<article class="blog-details-content">
									...
									<img src="{{ URL::asset('images/blog/blog_img_21.jpg') }}" alt="" class="image-meta w-100">
									<h4>This response is important for our ability to from mistakes but it alsogives rise to self-criticism make suda amet eget enim.</h4>
									<p>One touch of a red-hot stove is usually all we need to avoid that kind of discomfort in  future The same is true as we experienc the emotional of stress from our instances. We are Excepteur sint occaecat cupidatat consectetur faucibu nisl. quickly learn to fear and thus automatically. Lorem ipsum dolor sit amet, consectetur adip ismollit anim elit quis extraction labore leo inter pellentesque.</p>
