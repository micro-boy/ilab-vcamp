...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			=====================================================
			-->
			<div class="blog-section-five mt-160 mb-150 lg-mt-100 lg-mb-120">
				<div class="container">
							...
							<div class="blog-meta-wrapper pe-xxl-5">
								<article class="blog-meta-five">
									<div class="img-meta position-relative">
										<img src="{{ URL::asset('images/blog/blog_img_10.jpg') }}" alt="" class="w-100">
										<a href="{{ url('blog.blog-detailsV1') }}" class="tag">Soltuion</a>
									</div>
									<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
									<a href="{{ url('blog.blog-detailsV1') }}" class="title">Print, publishing qui visual ux quis layout mockups.</a>
									<a href="{{ url('blog.blog-detailsV1') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
								</article> <!-- /.blog-meta-five -->
								<article class="blog-meta-five">
									<div class="img-meta position-relative">
										<img src="{{ URL::asset('images/blog/blog_img_11.jpg') }}" alt="" class="w-100">
										<a href="{{ url('blog.blog-detailsV1') }}" class="tag">Soltuion</a>
									</div>
									<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
									<a href="{{ url('blog.blog-detailsV1') }}" class="title">Make more productive working flow daily.</a>
									<a href="{{ url('blog.blog-detailsV1') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
								</article> <!-- /.blog-meta-five -->

								<article class="blog-meta-five text-style">
									<a href="{{ url('blog.blog-detailsV1') }}" class="tag">Soltuion</a>
									<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
									<a href="{{ url('blog.blog-detailsV1') }}" class="title">Medieval origins to the digital era,  everything there is to know. Excepteur sint occaecat cupidatat </a>
									<a href="{{ url('blog.blog-detailsV1') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
								</article> <!-- /.blog-meta-five -->
								<article class="blog-meta-five">
									<div class="img-meta position-relative">
										<img src="{{ URL::asset('images/blog/blog_img_12.jpg') }}" alt="" class="w-100">
										<a href="{{ url('blog.blog-detailsV1') }}" class="tag">Soltuion</a>
									</div>
									<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
									<a href="{{ url('blog.blog-detailsV1') }}" class="title">Quis nostrud exercitation ullamco labo nisi ut aliquip cons.</a>
									<a href="{{ url('blog.blog-detailsV1') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
								</article> <!-- /.blog-meta-five -->
								<article class="blog-meta-five">
									<div class="img-meta position-relative">
										<img src="{{ URL::asset('images/blog/blog_img_13.jpg') }}" alt="" class="w-100">
										<a href="{{ url('blog.blog-detailsV1') }}" class="tag">Soltuion</a>
									</div>
									<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
									<a href="{{ url('blog.blog-detailsV1') }}" class="title">Designer’s Checklist for Every UX/UI Project.</a>
									<a href="{{ url('blog.blog-detailsV1') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
								</article> <!-- /.blog-meta-five -->
