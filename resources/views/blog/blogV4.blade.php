						...
						<div class="col-xxl-9 col-lg-10 m-auto">
							<article class="blog-meta-five">
								<div class="img-meta position-relative">
									<img src="{{ URL::asset('images/blog/blog_img_14.jpg') }}" alt="" class="w-100">
								</div>
								<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="title">Print, publishing qui visual ux quis layout mockups.</a>
							...
							<article class="blog-meta-five">
								<div class="img-meta position-relative">
									<img src="{{ URL::asset('images/blog/blog_img_15.jpg') }}" alt="" class="w-100">
								</div>
								<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="title">Quis nostrud exercitation ullamco laboris nisi ut aliquip commodo cons.</a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
							</article> <!-- /.blog-meta-five -->
							<article class="blog-meta-five text-style">
								<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="title">Medieval origins to the digital era,  everything there is to know. Excepteur sint occaecat cupidatat </a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
							</article> <!-- /.blog-meta-five -->
							<article class="blog-meta-five">
								<div class="img-meta position-relative">
									<img src="{{ URL::asset('images/blog/blog_img_16.jpg') }}" alt="" class="w-100">
								</div>
								<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="title">Make more productive working flow daily lorem quis.</a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
							</article> <!-- /.blog-meta-five -->
							<article class="blog-meta-five">
								<div class="img-meta position-relative">
									<img src="{{ URL::asset('images/blog/blog_img_17.jpg') }}" alt="" class="w-100">
								</div>
								<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="title">Designer’s Checklist for Every UX/UI Project lorem.</a>
								<a href="{{ url('blog.blog-detailsV3') }}" class="theme-btn-three">Continue reading <i class="fas fa-angle-right"></i></a>
							</article> <!-- /.blog-meta-five -->
						</div>
