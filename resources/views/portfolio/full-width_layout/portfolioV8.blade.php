	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="vcamp-text-block-one pt-180 md-pt-130">
				<div class="container">
					<div class="border-bottom pb-75 md-pb-50">
						<div class="row">
							<div class="col-12 m-auto">
								<div class="text-wrapper text-center ps-0">
									<div class="title-style-one">
										<h3 class="title">Portfolio Modern</h3>
									</div>
			...
			=====================================================
			-->
			<div class="portfolio-gallery-three full-width pt-100 pb-150 lg-pt-80 lg-pb-60">
				<div class="container-fluid">
					<ul class="style-none text-center isotop-menu-wrapper control-nav-four pb-75 lg-pb-50">
					...
					<div id="isotop-gallery-wrapper">
						...
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_28.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<a class="fancybox expend d-flex align-items-center justify-content-center tran3s" data-fancybox="" title="Click for large view" href="images/gallery/img_28.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
								</div>
								<div class="caption pe-xl-3 pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										...
										<div>
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
										</div>
									</div>
								</div> <!-- /.caption -->
							</div> <!-- /.gallery-item -->
						...
						<div class="isotop-item dev branding">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_29.jpg') }}" alt="" class="img-meta w-100 tran5s">
						...
						<div class="isotop-item plugin">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_30.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<a class="fancybox expend d-flex align-items-center justify-content-center tran3s" data-fancybox="" title="Click for large view" href="images/gallery/img_30.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
								</div>
								<div class="caption pe-xl-3 pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										<div>
											<span class="tag">BRANDING</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">e-Commerce App.</a></h6>
										</div>
										<div>
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
										</div>
						...
						<div class="isotop-item dev custom">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_31.jpg') }}" alt="" class="img-meta w-100 tran5s">
						...
						<div class="isotop-item branding">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_32.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<a class="fancybox expend d-flex align-items-center justify-content-center tran3s" data-fancybox="" title="Click for large view" href="images/gallery/img_32.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
								</div>
								<div class="caption pe-xl-3 pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										<div>
											<span class="tag">ILLUSTRATION</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Product Branding</a></h6>
										</div>
										<div>
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
										</div>
						...
						<div class="isotop-item dev">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_34.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<a class="fancybox expend d-flex align-items-center justify-content-center tran3s" data-fancybox="" title="Click for large view" href="images/gallery/img_34.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
								</div>
								<div class="caption pe-xl-3 pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										<div>
						...
						<div class="isotop-item branding">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_33.jpg') }}" alt="" class="img-meta w-100 tran5s">
								...
								<div class="caption pe-xl-3 pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										<div>
											<span class="tag">Branding</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">The Organic Sac</a></h6>
										</div>
										<div>
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
										</div>
						...
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_36.jpg') }}" alt="" class="img-meta w-100 tran5s">
								...
								<div class="caption pe-xl-3 pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										<div>
											...
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Efficient Team Mobile</a></h6>
										</div>
										<div>
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
										</div>
						...
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_35.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<a class="fancybox expend d-flex align-items-center justify-content-center tran3s" data-fancybox="" title="Click for large view" href="images/gallery/img_35.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
								</div>
								<div class="caption pe-xl-3 pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										<div>
