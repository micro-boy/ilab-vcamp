...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
							...
							<div class="col-12 m-auto">
								<div class="text-wrapper text-center ps-0">
									<div class="title-style-one">
										<h3 class="title">Portfolio Video Lightbox</h3>
									</div>
			...
			=====================================================
			-->
			<div class="portfolio-gallery-four full-width border-top pt-120 pb-130 lg-pt-80 lg-pb-100">
					...
					<div class="wrapper">
						<div id="isotop-gallery-wrapper">
							<div class="isotop-item plugin item-xl">
								<div class="gallery-item mb-40 md-mb-30">
							...
							<div class="isotop-item dev">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_48.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_48.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
							...
							<div class="isotop-item plugin">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_49.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_49.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
							...
							<div class="isotop-item dev custom">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_51.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_51.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">MOBILE</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
										</div> <!-- /.caption -->
							...
							<div class="isotop-item plugin">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_52.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_52.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Print</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">3D Composition.</a></h6>
										</div> <!-- /.caption -->
							...
							<div class="isotop-item item-xl custom">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
							...
							<div class="isotop-item branding custom">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_54.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_54.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">MOBILE</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
										</div> <!-- /.caption -->
							...
							<div class="isotop-item branding">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_55.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox video-icon tran3s overlay-icon" data-fancybox="" href="https://www.youtube.com/embed/aXFSJTjVjw0"><i class="bi bi-play-fill"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Print</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">3D Composition.</a></h6>
							...
							<div class="isotop-item branding custom">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_57.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_57.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">MOBILE</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
										</div> <!-- /.caption -->
							...
							<div class="isotop-item branding">
								<div class="gallery-item mb-40 md-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_58.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox video-icon tran3s overlay-icon" data-fancybox="" href="https://www.youtube.com/embed/aXFSJTjVjw0"><i class="bi bi-play-fill"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Print</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">3D Composition.</a></h6>
						...
						<div class="load-more-item1 text-center mt-80 lg-mt-40">
