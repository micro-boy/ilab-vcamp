...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
							...
							<div class="col-12 m-auto">
								<div class="text-wrapper text-center ps-0">
									<div class="title-style-one">
										<h3 class="title">Portfolio Masonry</h3>
									</div>
			...
			============================================== 
			-->
			<div class="case-study-seven border-top pt-130 lg-pt-80">
				<div class="container">
					<ul class="style-none text-center isotop-menu-wrapper control-nav-two pb-90 lg-pb-40">
						...
						<div class="isotop-item plugin">
							<div class="case-block-six">
								...
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}">Lonely <span>Steve</span></a></h4>
			...
			=====================================================
			-->
			<div class="fancy-banner-five mt-150 mb-150 lg-mt-100 lg-mb-100">
				<div class="container text-center">
					<div class="row">
						<div class="col-xl-9 col-lg-7 col-md-10 m-auto">
							<h2 class="title font-recoleta">Do you have any projects? Contact us.</h2>
						</div>
					</div>
