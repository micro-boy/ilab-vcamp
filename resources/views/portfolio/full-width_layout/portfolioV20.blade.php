...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			=====================================================
			-->
			<div class="portfolio-gallery-seven portfolio-gallery-three border-top mt-140 md-mt-90 d-sm-flex">
				<div class="portfolio-sidebar">
					<h4 class="title mb-30 lg-mb-20">Categories</h4>
					<ul class="style-none isotop-menu-wrapper control-nav-five d-sm-flex flex-column pb-40">
					...
					<h4 class="title mb-20">Share it.</h4>
				...
				<div class="main-gallery-wrapper border-left grid-3column">
					<h2 class="title2 mb-70 lg-mb-40">Portfolio All</h2>
					<div id="isotop-gallery-wrapper">
						<div class="grid-sizer"></div>
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_78.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										...
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_78.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
						...
						<div class="isotop-item dev branding">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_79.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_79.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
								<div class="caption pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
						...
						<div class="isotop-item plugin">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_80.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_80.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
								<div class="caption pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
						...
						<div class="isotop-item dev custom">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_81.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_81.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
								<div class="caption pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
						...
						<div class="isotop-item branding">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_82.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_82.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
								<div class="caption pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
						...
						<div class="isotop-item dev">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_83.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_83.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
								<div class="caption pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
						...
						<div class="isotop-item branding">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_84.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_84.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
								<div class="caption pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										<div>
											<span class="tag">Branding</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">New Typface</a></h6>
										</div>
									</div>
								</div> <!-- /.caption -->
							</div> <!-- /.gallery-item -->
						...
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_85.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_85.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
								<div class="caption pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
										<div>
											<span class="tag">ILLUSTRATION</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Sketcbook Mockup</a></h6>
										</div>
									</div>
								</div> <!-- /.caption -->
							</div> <!-- /.gallery-item -->
						...
						<div class="isotop-item dev branding">
							<div class="gallery-item mb-60 lg-mb-50">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_86.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="expend tran3s d-flex align-items-center justify-content-center">
										<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
										<a class="fancybox ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_86.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
									</div> <!-- /.expend -->
								</div>
								<div class="caption pt-30 lg-pt-20">
									<div class="d-flex align-items-center justify-content-between">
			...
			=====================================================
			-->
			<div class="vcamp-footer-four border-top">
				<div class="container">
					<div class="inner-content">
						<div class="row">
