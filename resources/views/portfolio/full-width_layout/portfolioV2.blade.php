...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			    		...
			    		<div class="col-12 m-auto">
			    			<div class="mixitUp-container clearfix">
			    				<div class="mix customization">
			    					<div class="case-block-three position-relative">
										...
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
			    				...
			    				<div class="mix dev branding">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/media/img_47.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.todo.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			    				...
			    				<div class="mix customization">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/media/img_48.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.slack.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			    				...
			    				<div class="mix dev">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/media/img_49.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.todo.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			    				...
			    				<div class="mix plugin branding">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/gallery/img_05.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.slack.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			    				...
			    				<div class="mix plugin">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/gallery/img_06.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.todo.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			    				...
			    				<div class="mix dev branding">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/gallery/img_07.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.slack.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			    				...
			    				<div class="mix customization">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/gallery/img_08.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.todo.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			    				...
			    				<div class="mix dev branding">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/gallery/img_09.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.slack.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			    				...
			    				<div class="mix plugin">
			    					<div class="case-block-three position-relative">
										<img src="{{ URL::asset('images/gallery/img_10.jpg') }}" alt="" class="screen">
										<div class="overlay-content d-flex align-items-end">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="d-flex justify-content-between align-items-center" tabindex="0">
												<span>www.todo.com</span>
												<img src="{{ URL::asset('images/icon/icon_28.svg') }}" alt="">
			...
			=====================================================
			-->
			<div class="fancy-banner-three bg-white mt-40 lg-mt-10">
