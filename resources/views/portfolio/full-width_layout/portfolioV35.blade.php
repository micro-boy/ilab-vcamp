		...
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-three">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<h2 class="page-title font-recoleta">Our <span>client</span> case study.</h2>
						</div>
			...
			<div class="box-layout">
				<div class="case-study-four border-top pt-110">
					<div class="controls control-nav-two text-center pb-45 lg-pb-10">
				    					...
				    					<div class="col-xl-6 col-md-8">
				    						<div class="text-wrapper" data-aos="fade-right">
				    							<div class="icon d-flex align-items-center justify-content-center mb-20">
				    								<img src="{{ URL::asset('images/icon/icon_50.svg') }}" alt="">
				    							</div>
					    						<blockquote>
												...
												<div class="d-flex align-items-center info-meta">
													...
													<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="more"><i class="bi bi-chevron-right"></i></a>
												</div>
				    						</div> <!-- /.text-wrapper -->
				    					</div>
				    				</div>
				    			</div>
				    			<img src="{{ URL::asset('images/media/img_50.png') }}" alt="" class="screen screen-right" data-aos="fade-left">
				    		</div> <!-- /.case-block-four -->
				    	</div>

				    	<div class="mix dev">
				    		<div class="case-block-four position-relative" style="background: #E9F4FF;">
				    			<div class="container">
				    				<div class="row">
				    					<div class="col-xl-6 col-md-8 ms-auto">
				    						<div class="text-wrapper" data-aos="fade-left">
				    							<div class="icon d-flex align-items-center justify-content-center mb-20">
				    								<img src="{{ URL::asset('images/icon/icon_50.svg') }}" alt="">
				    							</div>
					    						<blockquote>
													“Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor <span>incididunt</span> veniam, exercitation ullamco laboris nisi ut aliqui”
												</blockquote>
												<div class="d-flex align-items-center info-meta">
													<img src="{{ URL::asset('images/media/img_02.jpg') }}" alt="" class="avatar">
													<div class="name">Zubayer Ha. <span>VP, Technology</span></div>
				    			...
				    			<img src="{{ URL::asset('images/media/img_51.jpg') }}" alt="" class="screen screen-left" data-aos="fade-right">
				    		</div> <!-- /.case-block-four -->
				    	</div>

				    	<div class="mix plugin">
				    		<div class="case-block-four position-relative" style="background: #F6EAE0;">
				    			<div class="container">
				    				<div class="row">
				    					<div class="col-xl-6 col-md-8">
				    						<div class="text-wrapper" data-aos="fade-right">
				    			...
				    			<img src="{{ URL::asset('images/media/img_52.jpg') }}" alt="" class="screen screen-right" data-aos="fade-left">
				    		</div> <!-- /.case-block-four -->
				    	</div>

				    	<div class="mix customization">
				    		<div class="case-block-four position-relative" style="background: #F2F1FF;">
				    			<div class="container">
				    				<div class="row">
				    					<div class="col-xl-6 col-md-8 ms-auto">
				    						<div class="text-wrapper" data-aos="fade-left">
				    			...
				    			<img src="{{ URL::asset('images/media/img_53.jpg') }}" alt="" class="screen screen-left" data-aos="fade-right">
				    		</div> <!-- /.case-block-four -->
				    	</div>
			...
			=====================================================
			-->
			<div class="fancy-banner-three bg-white mt-40 mb-40">
							...
							<div class="col-xxl-11 m-auto">
								<div class="row align-items-center">
									<div class="col-lg-6 col-md-8">
										<h2 class="title font-recoleta text-center text-md-start">Have any <span>project</span> in mind?</h2>
									</div>
