...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="vcamp-text-block-one pt-180 md-pt-130 dark-bg">
				<div class="container">
						...
						<div class="row">
							<div class="col-12 m-auto">
								<div class="text-wrapper text-center ps-0">
									...
									<p class="text-lg text-white pt-35 lg-pt-30">An original way to show your works in a good appearance.</p>
								</div>
							</div>
						</div>
					</div>
			...
			=====================================================
			-->
			<div class="case-study-six dark-bg border-top ms-auto me-auto">
				<div class="container">
			...
			=====================================================
			-->
			<footer class="vcamp-footer-two dark-footer border-top pt-150 lg-pt-100">
				<div class="container">
					<div class="row">
