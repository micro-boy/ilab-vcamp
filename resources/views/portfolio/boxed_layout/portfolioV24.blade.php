					...
					<div class="slider-wrapper position-relative">
						...
						<div class="portfolio-slider-two hvr-overlay-right galley-item-wrapper gap15">
									...
									<div class="img-holder">
										...
										<div class="caption d-flex justify-content-end align-items-center flex-column">
											<div class="icon-group d-flex align-items-center justify-content-center">
												<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
							...
							<div class="item">
								<div class="gallery-item">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_87.jpg') }}" alt="" class="img-meta w-100 tran5s">
										<div class="caption d-flex justify-content-end align-items-center flex-column">
											<div class="icon-group d-flex align-items-center justify-content-center">
												<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
												<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_87.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
											</div> <!-- /.icon-group -->
