...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
				...
				<div class="inner-content">
					<div class="d-flex align-items-center justify-content-between">
						...
						<div class="right-widget d-flex align-items-center">
							...
							<button class="sidebar-nav-button d-none d-lg-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><img src="{{ URL::asset('images/icon/icon_45.svg') }}" alt=""></button>
						</div> <!-- /.right-widget -->
					</div>
				</div> <!-- /.inner-content -->
			...
			============================================== 
			-->
			<div class="inside-hero-two" style="background-image: url(images/media/img_61.jpg);">
				<div class="container">
					<h2 class="page-title">Portfolio Masonry</h2>
					<p>An original way to show your works in a good appearance.</p>
				</div>
				<img src="{{ URL::asset('images/shape/shape_24.svg') }}" alt="" class="shapes shape-one">
			</div> <!-- /.inside-hero-two -->
			...
			=====================================================
			-->
			<div class="portfolio-gallery-six pt-120 pb-100 lg-pt-80 lg-pb-30">
				<div class="container">
					...
					<div id="isotop-gallery-wrapper" class="hvr-overlay-right galley-item-wrapper grid-3column">
						<div class="grid-sizer"></div>
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_69.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_69.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
						...
						<div class="isotop-item dev branding">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_70.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_70.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
						...
						<div class="isotop-item plugin">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_71.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_71.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
										<span class="tag">MOBILE</span>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item dev custom">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_73.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_73.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
						...
						<div class="isotop-item branding">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_72.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_72.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
										<span class="tag">MOBILE</span>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item branding">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_74.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_74.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
										<span class="tag">Plugin</span>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item plugin">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_75.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_75.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
										<span class="tag">MOBILE</span>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item dev branding">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_77.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_77.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
						...
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_76.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-end align-items-center flex-column">
										<div class="icon-group d-flex align-items-center justify-content-center">
											<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s me-2"><i class="bi bi-arrow-up-right"></i></a>
											<a class="fancybox tran3s ms-2" data-fancybox="" title="Click for large view" href="images/gallery/img_76.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										</div> <!-- /.icon-group -->
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
			...
			=====================================================
			-->
			<div class="fancy-banner-one mt-50">
