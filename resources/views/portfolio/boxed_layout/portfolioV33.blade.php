	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-one hero-spacing">
				<div class="container">
					<h2 class="page-title font-recoleta">Portfolio 4 Column</h2>
			...
			<div class="portfolio-gallery-four pt-150 pb-140 lg-pt-100 lg-pb-80">
				<div class="container-fluid">
					...
					<div class="wrapper">
						<div id="isotop-gallery-wrapper" class="grid-4column">
								...
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											...
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Evening Shindig</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
								...
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											...
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Moving Bird</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
								...
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											...
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">The Discovery</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
								...
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											...
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Passion Chasers</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item branding">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">UI/UX</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Strive Training</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
								...
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											...
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Yellow Moose</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							...
							<div class="isotop-item plugin">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Art</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Limitless Horizons</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
								...
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											...
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Town Hall</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item custom plugin">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										...
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Branding</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Social Geek Made</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
