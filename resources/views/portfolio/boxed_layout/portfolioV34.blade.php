	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-one hero-spacing">
				<div class="container">
					<h2 class="page-title font-recoleta">Portfolio 5 Column</h2>
			...
			=====================================================
			-->
			<div class="portfolio-gallery-four pt-150 pb-140 lg-pt-100 lg-pb-80">
				<div class="container-fluid">
					...
					<div class="wrapper">
						<div id="isotop-gallery-wrapper" class="grid-5column">
							<div class="grid-sizer"></div>
							<div class="isotop-item plugin">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_89.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_89.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">UI/UX</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Evening Shindig</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item dev branding">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_90.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_90.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Plugin</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Moving Bird</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item custom plugin">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_91.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_91.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">3D</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">The Discovery</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item custom dev">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_92.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_92.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Development</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Passion Chasers</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item branding">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_93.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_93.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">UI/UX</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Strive Training</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item plugin">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_94.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_94.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Art</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Yellow Moose</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item dev branding">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_95.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_95.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
							...
							<div class="isotop-item custom plugin">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_96.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_96.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
							...
							<div class="isotop-item custom dev">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_97.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_97.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">PRINT</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">3D Composition</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item plugin">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_98.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_98.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Art</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Limitless Horizons</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item dev branding">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_99.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_99.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Web</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Town Hall</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item custom plugin">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_100.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_100.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Branding</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Social Geek Made</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item branding">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_101.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_101.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">UI/UX</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Strive Training</a></h6>
										</div> <!-- /.caption -->
							...
							<div class="isotop-item plugin">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_102.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_102.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Art</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Yellow Moose</a></h6>
										</div> <!-- /.caption -->
							...
							<div class="isotop-item dev branding">
								<div class="gallery-item mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_103.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_103.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Branding</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Anaylsis Application</a></h6>
										</div> <!-- /.caption -->
