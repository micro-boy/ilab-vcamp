									...
									<div class="caption pe-xl-3 pt-30 lg-pt-20">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												...
												<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="pj-title">Anaylsis Application</a></h6>
											</div>
											<div>
												<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
											</div>
										</div>
									</div> <!-- /.caption -->
								</div> <!-- /.gallery-item -->
									...
									<div class="caption pe-xl-3 pt-30 lg-pt-20">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												...
												<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="pj-title">Weather App</a></h6>
											</div>
											<div>
												<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
											</div>
									...
									<div class="caption pe-xl-3 pt-30 lg-pt-20">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												...
												<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="pj-title">e-Commerce App</a></h6>
											</div>
											<div>
												<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
											</div>
									...
									<div class="caption pe-xl-3 pt-30 lg-pt-20">
										<div class="d-flex align-items-center justify-content-between">
											<div>
												...
												<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="pj-title">Product Branding</a></h6>
											</div>
											<div>
												<a href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}" class="arrow tran3s"><i class="bi bi-arrow-up-right"></i></a>
											</div>
