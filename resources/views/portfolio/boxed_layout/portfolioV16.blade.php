	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-one hero-spacing">
				<div class="container">
					<h2 class="page-title font-recoleta">Portfolio Metro</h2>
			...
			=====================================================
			-->
			<div class="portfolio-gallery-five pt-120 pb-100 lg-pt-80 lg-pb-50">
				<div class="container">
					<ul class="style-none text-center isotop-menu-wrapper control-nav-six pb-75 lg-pb-40">
					...
					<div id="isotop-gallery-wrapper" class="hvr-shutter-out">
						<div class="grid-sizer"></div>
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_59.jpg') }}" alt="" class="img-meta w-100 tran5s">
						...
						<div class="isotop-item dev branding">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_60.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
						...
						<div class="isotop-item plugin">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_61.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
						...
						<div class="isotop-item item-xl branding">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_63.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
						...
						<div class="isotop-item dev custom">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_62.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
										<span class="tag">ILLUSTRATION</span>
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Product Branding.</a></h6>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item branding">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_65.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
										<span class="tag">ILLUSTRATION</span>
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Product Branding.</a></h6>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item plugin">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_68.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
										<span class="tag">Branding</span>
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Anaylsis Application.</a></h6>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item plugin custom">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_67.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
										<span class="tag">MOBILE</span>
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Weather App.</a></h6>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item dev branding">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_66.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
										<span class="tag">Development</span>
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">e-Commerce App.</a></h6>
									</div> <!-- /.caption -->
						...
						<div class="isotop-item item-xl dev">
							<div class="gallery-item mb-40 lg-mb-30">
								<div class="img-holder">
									<img src="{{ URL::asset('images/gallery/img_64.jpg') }}" alt="" class="img-meta w-100 tran5s">
									<div class="caption d-flex justify-content-center align-items-center flex-column">
										<span class="tag">ILLUSTRATION</span>
										<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV5') }}" class="pj-title">Product Branding.</a></h6>
									</div> <!-- /.caption -->
			...
			=====================================================
			-->
			<div class="fancy-banner-five mb-150 lg-mb-100">
