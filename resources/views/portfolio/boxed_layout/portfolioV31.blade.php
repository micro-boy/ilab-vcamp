	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-one hero-spacing">
				<div class="container">
					<h2 class="page-title font-recoleta">Portfolio 2 Column</h2>
			...
			<div class="portfolio-gallery-four pt-150 pb-140 lg-pt-100 lg-pb-80">
				<div class="container">
					...
					<div class="wrapper ps-xxl-4 pe-xxl-4">
						<div id="isotop-gallery-wrapper" class="grid-2column">
							...
							<div class="isotop-item plugin">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_38.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_38.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">UI/UX</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Disruptor Training</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item dev branding">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_39.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_39.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Web</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Match of Health</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item custom plugin">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_40.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_40.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">mobile</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">The Domain</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item custom dev">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_41.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_41.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Print</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Charged by Codes</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item branding">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_42.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_42.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Branding</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Box of Crayons</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item plugin">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_43.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_43.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">UI/UX</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">The Principal</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item dev branding">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_44.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_44.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Plugin</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Hex Clan</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item custom plugin">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_45.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_45.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Code</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Celestial Interface</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
							<div class="isotop-item custom dev">
								<div class="gallery-item mb-40 lg-mb-30">
									<div class="img-holder">
										<img src="{{ URL::asset('images/gallery/img_46.jpg') }}" alt="" class="img-meta w-100 tran6s">
										<a class="fancybox tran3s overlay-icon zoom-icon" data-fancybox="" title="Click for large view" href="images/gallery/img_46.jpg" tabindex="0"><i class="bi bi-plus"></i></a>
										<div class="caption tran3s d-flex justify-content-end flex-column">
											<span class="tag">Mobile</span>
											<h6><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV3') }}" class="pj-title">Husky Cat</a></h6>
										</div> <!-- /.caption -->
									</div>
								</div> <!-- /.gallery-item -->
							</div> <!-- /.isotop-item -->
