...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="inside-hero-one hero-spacing text-start">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-md-6">
							<h2 class="page-title font-recoleta theme-mb-0">Portfolio Video Lightbox</h2>
						</div>
						<div class="col-xl-5 col-md-6 ms-auto">
							<div class="text-lg sm-pt-20">Our founders Dustin Moskovitz and Justin Rosenstein met while leading Engineering teams at Facebook.</div>
						</div>
					</div>
				</div>
			</div> <!-- /.inside-hero-one -->
			...
			=====================================================
			-->
			<div class="portfolio-gallery-four pt-150 pb-140 lg-pt-80 lg-pb-100">
				<div class="container">
