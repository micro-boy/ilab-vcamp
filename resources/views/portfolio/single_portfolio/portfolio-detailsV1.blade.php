...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="inside-hero-four bg-color hero-spacing">
				<div class="container">
					<div class="row">
					...
					<img src="{{ URL::asset('images/media/img_54.jpg') }}" alt="" class="screen">
				</div>
							...
							<div class="border-block">
								...
								<div class="row">
									<div class="col-sm-6" data-aos="fade-right">
										<div class="img-meta">
											<a class="fancybox d-block" data-fancybox="" href="images/media/img_56.jpg" tabindex="-1">
												<img src="{{ URL::asset('images/media/img_56.jpg') }}" alt="" class="w-100">
											</a>
										</div>
									</div>
									<div class="col-sm-6" data-aos="fade-left">
										<div class="img-meta">
											<a class="fancybox d-block" data-fancybox="" href="images/media/img_57.jpg" tabindex="-1">
												<img src="{{ URL::asset('images/media/img_57.jpg') }}" alt="" class="w-100">
											</a>
										</div>
									</div>
								</div>
			...
			=====================================================
			-->
			<div class="fancy-banner-five mb-150 lg-mb-100" data-aos="fade-up">
				<div class="container">
					<div class="row">
						<div class="col-xxl-11 m-auto">
							<div class="bg-wrapper dark-bg">
								<div class="row">
									<div class="col-xl-7 col-lg-6 col-md-7 m-auto">
