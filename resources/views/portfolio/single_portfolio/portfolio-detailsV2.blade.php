...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper dark-bg">
			  		...
			  		<ul class="style-none">
			  			...
			  			<li class="nav-item dropdown">
						    ...
						    <ul class="dropdown-menu">
					            ...
					            <li><a href="{{ url('portfolio.single_portfolio.portfolioV25') }}"" class="dropdown-item"><span>Single Portfolio 01</span></a></li>
			...
			============================================== 
			-->
			<div class="inside-hero-four dark-bg text-center border-top mt-140 md-mt-90">
				<div class="container">
					<div class="row">
						<div class="col-xxl-9 col-md-10 m-auto">
							<h6>Case study</h6>
							<h2 class="page-title font-recoleta">Building <span>slack</span> with decoupled WordPress & Gatsby</h2>
							<p>vCamp delivered blazing fast performance, striking visual design & soludtion</p>
						</div>
					</div>
					<img src="{{ URL::asset('images/gallery/img_110.jpg') }}" alt="" class="screen">
				</div>
				<img src="{{ URL::asset('images/shape/shape_31.svg') }}" alt="" class="shapes shape-one">
				<img src="{{ URL::asset('images/shape/shape_32.svg') }}" alt="" class="shapes shape-two">
			</div> <!-- /.inside-hero-four -->
			...
			=====================================================
			-->
			<div class="case-details-one dark-bg border-top">
				<div class="container">
					<div class="row">
						<div class="col-xl-9 m-auto">
							<h6 class="sub-heading">overview</h6>
							<h3 class="title font-recoleta">About Rodpen</h3>
							...
							<div class="border-block">
								...
								<h3 class="title font-recoleta">Find out the design <br> solution.</h3>
								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
								<p>Enim eu turpis egestas pretium aenean pharetra. Dui accumsan sit amet nulla facilisi morbi tempus iaculis. Eu ultrices vitae auctor eu augue. Sed turpis tincidunt id aliquet risus  Purus in massa tempor nec feugiat nisl pretium fusce. Feugiat vivamus at augue eget arcu dictum. Gravida quis blandit turpis cursus in hac habitasse platea dictumst. </p>
								<div class="row">
									<div class="col-sm-6" data-aos="fade-right">
										<div class="img-meta">
											<a class="fancybox d-block" data-fancybox="" href="images/media/img_59.jpg" tabindex="-1">
												<img src="{{ URL::asset('images/media/img_59.jpg') }}" alt="" class="w-100">
											</a>
										</div>
									</div>
									<div class="col-sm-6" data-aos="fade-left">
										<div class="img-meta">
											<a class="fancybox d-block" data-fancybox="" href="images/media/img_60.jpg" tabindex="-1">
												<img src="{{ URL::asset('images/media/img_60.jpg') }}" alt="" class="w-100">
											</a>
										</div>
									</div>
								</div>
								<h3 class="title font-recoleta">Finalize the project</h3>
								<p>Id nibh tortor id aliquet lectus proin nibh nisl condimentum. Habitant morbi tristique senectus et. Lectus urna duis convallis convallis tellus id interdum velit laoreet.</p>
								<p>Enim eu turpis egestas pretium aenean pharetra. Dui accumsan sit amet nulla facilisi mor tempu iaculis. Eu ultrices vitae auctor eu augue. Sed turpis tincidunt id aliquet risus  Purus in massa tempor nec feugiat nisl pretium fusce. Feugiat vivamus at augue eget arcu dictum. Gravida quis blandit turpis cursus in hac habitasse platea dictumst. </p>
							</div> <!-- /.border-block -->
							<h6 class="sub-heading">Result</h6>
							<h3 class="title font-recoleta">Final Result</h3>
							<p>Id nibh tortor id aliquet lectus proin nibh nisl condimentum. Habitant morbi tristique senectus et. Lectus urna duis convallis convallis tellus id interdum velit laoreet.</p>
							<div class="img-meta" data-aos="fade-up">
								<a class="fancybox d-block" data-fancybox="" href="images/media/img_58.jpg" tabindex="-1">
									<img src="{{ URL::asset('images/media/img_58.jpg') }}" alt="" class="w-100">
								</a>
							</div>
							<p>Content creators and human resources personnel are able to seamlessly update the website through graphical interfaces, and the site simply rebuilds itself along with search engine indexes as the OpenWeb team continues to create.</p>
							<p>Enim eu turpis egestas pretium aenean pharetra. Dui accumsan sit amet nulla facilisi mor tempu iaculis. Eu ultrices vitae auctor eu augue. Sed turpis tincidunt id aliquet risus  Purus in massa tempor nec feugiat nisl pretium fusce. Feugiat vivamus at augue eget arcu dictum. Gravida quis blandit turpis cursus in hac habitasse platea dictumst. </p>
						</div>
					</div>
				</div>
			</div> <!-- /.case-details-one -->
			...
			=====================================================
			-->
			<div class="fancy-banner-nine dark-bg pb-20">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-md-6 mb-40">
							<div class="newsletter">
								...
								<p>Join over <span class="color2">68,000</span> people getting our emails</p>
								<form action="#">
									<input type="email" placeholder="Enter your email">
									<button class="color2-btn">Sign Up</button>
								</form>
