...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper dark-bg">
			...
			=====================================================
			-->
			<div class="pr-details-one border-top mt-140 md-mt-90 pt-110 md-pt-80 mb-170 lg-mb-100">
				<div class="container">
					<div class="wrapper ps-xxl-4 pe-xxl-4">
						<div class="row">
							<div class="col-lg-6">
								<div class="title-style-ten">
									...
									<h2 class="title">vCamp website page design with Branding</h2>
								</div>
								<div class="text-wrapper pt-35">
									<p>We’ve created a unique visual system and strategy across the wide existing spectrum of visible mobile applications & found yourself in a wide, straggling with. </p>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="project-info ps-xl-5">
									...
									<ul class="d-flex social-icon-two style-none mt-20">
						...
						<div class="portfolio-gallery-four pt-40">
							<div class="row">
								<div class="col-12">
									<div class="img-meta mb-50 lg-mb-30">
								...
								<div class="col-lg-6">
									<div class="img-meta mb-50 lg-mb-30">
										<a class="fancybox d-block" data-fancybox="" href="images/gallery/img_58.jpg" tabindex="-1">
											<img src="{{ URL::asset('images/gallery/img_58.jpg') }}" alt="" class="w-100">
										</a>
									</div> <!-- /.img-meta -->
								</div>
								<div class="col-lg-6">
									<div class="img-meta mb-50 lg-mb-30">
										<a class="fancybox d-block" data-fancybox="" href="images/gallery/img_49.jpg" tabindex="-1">
											<img src="{{ URL::asset('images/gallery/img_49.jpg') }}" alt="" class="w-100">
										</a>
									</div> <!-- /.img-meta -->
								</div>
							</div>
						...
						<div class="pr-pagination-one mt-30">
								...
								<li>
									<a href="#">
										<span class="d-flex align-items-end">
											...
											<span class="ms-3">
												<span class="pr-dir d-block">Previous</span>
												<span class="pr-name">Uber App Redesign</span>
											</span>
										</span>
									</a>
								</li>
			...
			=====================================================
			-->
			<div class="fancy-banner-nine dark-bg pb-80 lg-pb-50">
				<div class="container">
			...
			=====================================================
			-->
			<div class="vcamp-footer-four dark-bg">
				<div class="container">
					<div class="inner-content">
						<div class="row">
							<div class="col-xxl-10 m-auto">
								<ul class="style-none footer-nav d-flex flex-wrap justify-content-center align-items-center md-mt-60">
									...
									<li class="logo text-center"><a href="{{ url('home.index') }}"><img src="{{ URL::asset('images/logo/vCamp_11.png') }}" alt="" width="54"></a></li>
