...
<html lang="en">
	...
	<body>
		<div class="h-100">
			...
			============================================== 
			-->
			<header class="theme-main-menu theme-menu-one bg-white">
				<div class="inner-content">
					<div class="d-flex align-items-center justify-content-between">
						<div class="logo"><a href="{{ url('home.index') }}"><img src="{{ URL::asset('images/logo/vCamp.svg') }}" alt=""></a></div>
			...
			============================================== 
			-->
			<div class="page-scroll-element-one">
									...
									<div id="carouselOne" class="carousel slide carousel-fade" data-bs-ride="carousel">
										...
										<div class="carousel-inner">
										    <div class="carousel-item active">
										    	<a class="d-block" href="{{ url('portfolio.single_portfolio.portfolio-detailsV1') }}">
