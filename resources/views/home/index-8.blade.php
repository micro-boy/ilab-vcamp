		...
		<div class="main-page-wrapper">
			...
			<header class="theme-main-menu sticky-menu theme-menu-one">
				<div class="inner-content">
					<div class="d-flex align-items-center justify-content-between">
						<div class="logo logo-xl"><a href="{{ url('home.index') }}"><img src="{{ URL::asset('images/logo/vCamp_09.svg') }}" alt=""></a></div>
						...
						<div class="right-widget d-flex align-items-center">
							...
							<button class="sidebar-nav-button d-none d-lg-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight" aria-controls="offcanvasRight"><img src="{{ URL::asset('images/icon/icon_68.svg') }}" alt=""></button>
						</div> <!-- /.right-widget -->
					</div>
				</div> <!-- /.inner-content -->
							...
							<div class="row align-items-end">
								<div class="col-xl-5 col-md-6">
									<div class="product-text">
										<h6>Top Qulaity</h6>
										<h2 class="font-recoleta">Summer <br> Item.</h2>
										<p class="text-lg mb-50 lg-mb-30">We helpingclient  to create websites with our talented expert.</p>
										<a href="{{ url('shop.productV1') }}" class="theme-btn-seven ripple-btn">SHOW NOW</a>
									</div> <!-- /.product-text -->
								</div>
								<div class="col-xl-7 col-md-6">
									<img src="{{ URL::asset('images/shop/img_01.png') }}" alt="" class="m-auto ms-lg-auto product-img tran5s">
								</div>
							</div>
						</div>
						...
						<div class="container">
							<div class="row align-items-end">
								<div class="col-xl-5 col-md-6">
									<div class="product-text">
										<h6>High Qulaity</h6>
										<h2 class="font-recoleta">Winter <br> Item.</h2>
										<p class="text-lg mb-50 lg-mb-30">We helpingclient  to create websites with our talented expert.</p>
										<a href="{{ url('shop.productV1') }}" class="theme-btn-seven ripple-btn">SHOW NOW</a>
									</div> <!-- /.product-text -->
								</div>
								<div class="col-xl-7 col-md-6">
									<img src="{{ URL::asset('images/shop/img_02.png') }}" alt="" class="m-auto ms-lg-auto product-img tran5s">
								</div>
							</div>
						</div>
						<div class="section-no">02.</div>
					</div>
				</div> <!-- /.shop-hero-slider-one -->
			</div> <!-- /.hero-banner-six -->
			...
			<div class="product-section-one mt-180 lg-mt-100">
					...
					<div class="row align-items-center justify-content-between">
						<div class="col-md-6 col-sm-8">
							<div class="title-style-six text-center text-sm-start xs-pb-20">
								<h2 class="title">All Collection</h2>
							</div>
						</div>
				...
				<div class="box-layout mt-90 lg-mt-40">
					<div class="product_slider_one product_slider_space">
						<div class="item">
							<div class="product-block-one">
								<a href="{{ url('shop.product-detailsV1') }}" class="d-flex align-items-center justify-content-center h-100"><img src="{{ URL::asset('images/shop/img_03.png') }}" alt="" class="product-img tran4s"></a>
								<a href="{{ url('shop.product-detailsV1') }}" class="category-tag">WOMAN</a>
							</div> <!-- /.product-block-one -->
						</div>
						<div class="item">
							<div class="product-block-one">
								<a href="{{ url('shop.product-detailsV1') }}" class="d-flex align-items-center justify-content-center h-100"><img src="{{ URL::asset('images/shop/img_04.png') }}" alt="" class="product-img tran4s"></a>
								<a href="{{ url('shop.product-detailsV1') }}" class="category-tag">Accessories</a>
							</div> <!-- /.product-block-one -->
						</div>
						<div class="item">
							<div class="product-block-one">
								<a href="{{ url('shop.product-detailsV1') }}" class="d-flex align-items-center justify-content-center h-100"><img src="{{ URL::asset('images/shop/img_05.png') }}" alt="" class="product-img tran4s"></a>
								<a href="{{ url('shop.product-detailsV1') }}" class="category-tag">FURNITURE</a>
							</div> <!-- /.product-block-one -->
						</div>
						<div class="item">
							<div class="product-block-one">
								<a href="{{ url('shop.product-detailsV1') }}" class="d-flex align-items-center justify-content-center h-100"><img src="{{ URL::asset('images/shop/img_06.png') }}" alt="" class="product-img tran4s"></a>
								<a href="{{ url('shop.product-detailsV1') }}" class="category-tag">SHOE</a>
							</div> <!-- /.product-block-one -->
						</div>
						<div class="item">
							<div class="product-block-one">
								<a href="{{ url('shop.product-detailsV1') }}" class="d-flex align-items-center justify-content-center h-100"><img src="{{ URL::asset('images/shop/img_09.png') }}" alt="" class="product-img tran4s"></a>
								<a href="{{ url('shop.product-detailsV1') }}" class="category-tag">Clothe</a>
							</div> <!-- /.product-block-one -->
						</div>
					</div>
				</div> <!-- /.box-layout -->
			...
			<div class="product-section-two mt-170 lg-mt-100">
				<div class="container">
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-lg-5 col-md-6 col-sm-4 d-flex justify-content-center justify-content-sm-end">
							<ul class="slider-arrows product-slider-arrow-one d-flex style-none">
								<li class="prev_p2 slick-arrow ripple-btn"><i class="bi bi-arrow-left"></i></li>
								<li class="next_p2 slick-arrow ripple-btn"><i class="bi bi-arrow-right"></i></li>
							</ul>
						</div>
					</div>
				</div>
						...
						<div class="item">
							<div class="product-block-two">
								<div class="img-holder">
									...
									<a href="{{ url('shop.cart') }}" class="cart-icon" title="Add To Cart"><i class="bi bi-cart-check"></i></a>
								</div> <!-- /.img-holder -->
			...
			<div class="product-section-three mt-130 pt-130 pb-150 lg-mt-100 lg-pt-80 lg-pb-70">
				<div class="container">
					<div class="row align-items-center justify-content-between">
						...
						<div class="col-lg-5 col-md-6 col-sm-4 d-flex justify-content-center justify-content-sm-end">
							<ul class="slider-arrows product-slider-arrow-one d-flex style-none">
								<li class="prev_p3 slick-arrow ripple-btn"><i class="bi bi-arrow-left"></i></li>
								<li class="next_p3 slick-arrow ripple-btn"><i class="bi bi-arrow-right"></i></li>
							</ul>
						</div>
					</div>
				</div>
							...
							<div class="col-12">
								<div class="row align-items-center">
									...
									<div class="col-sm-6 text-sm-end text-start">
										<a href="{{ url('blog.blogV2') }}" class="theme-btn-three">Check our all news <i class="fas fa-angle-right"></i></a>
									</div>
								</div>
