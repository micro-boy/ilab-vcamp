...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-three border-bottom border-top pt-35 pb-60 md-pb-40 md-pt-10">
				<div class="container">
					<div class="row gx-xl-5 justify-content-between">
						...
						<div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="100">
							<div class="card-style-three mt-50">
								...
								<h4 class="title">Dev & Design.</h4>
								<p>Creating a higher spacing how people move through. From its mel origins to the digital era.</p>
							</div> <!-- /.card-style-three -->
						</div>
						<div class="col-md-4 col-sm-6" data-aos="fade-up" data-aos-delay="200">
							<div class="card-style-three mt-50">
								...
								<p>Get a full cRontrol of debts in the dsu digital world simplesity. labore et dolore magna aliqua</p>
							</div> <!-- /.card-style-three -->
						</div>
					</div>
				</div>
			...
			<div class="vcamp-text-block-eleven mt-140 lg-mt-120">
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-5 ms-auto">
							<p class="meta-info-text md-pt-30">We are the startup studio with a <span>mission to partner</span> with the best founders.</p>
						</div>
					</div>
				</div>
				...
				<div class="main-content">
					...
					<div class="left-img-meta">
						<img src="{{ URL::asset('images/media/img_70.png') }}" alt="" class="w-100">
					</div> <!-- /.left-img-meta -->
				</div> <!-- /.main-content -->
			</div> <!-- /.vcamp-text-block-eleven -->
			...
			=====================================================
			-->
			<div class="counter-section-three border-bottom pt-120 pb-60 lg-pt-30 lg-pb-10">
				<div class="container">
					<div class="row">
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-five mt-90">
				<div class="container">
					<div class="row align-items-center align-items-xl-end">
						<div class="col-xl-6 col-lg-4 col-md-5 col-sm-8">
							<div class="title-style-nine text-center text-sm-start xs-pb-20">
								<h2 class="title">Our Success Story.</h2>
							</div>
						</div>
						<div class="col-xl-6 col-lg-8 col-md-7 col-sm-4 d-flex justify-content-center justify-content-sm-end">
				...
				<div class="feature_slider_one mt-70 lg-mt-50">
					<div class="item">
			...
			============================================== 
			-->
			<div class="vcamp-text-block-twelve mt-250 lg-mt-120 pb-20">
				<div class="container">
					<div class="row">
						<div class="col-xxl-5 col-xl-6 col-lg-7">
							<div class="text-wrapper">
								...
								<div class="title-style-nine pt-40 pb-45 lg-pb-30">
									<h2 class="title">Why Choose vCamp?</h2>
								</div>
								<p class="meta-info-text">So how does it work? Let’s check our Getting Started tutorial pre-made templates.</p>
								<ul class="style-none">
									<li>Makes them <span>purchase</span> your product, service and quis interact website due.</li>
									<li>Holds and catches their <span>attention</span> lorem.</li>
									<li>Diverts them to your brand.</li>
								</ul>
								<a href="{{ url('pages.support.contactV2') }}" class="theme-btn-twelve mt-45 lg-mt-30">Consult with an exprt now!</a>
							</div> <!-- /.text-wrapper -->
						</div>
					</div>
				</div>
				<div class="right-img-meta">
					<img src="{{ URL::asset('images/media/img_71.png') }}" alt="" class="w-100 main-img">
				</div> <!-- /.right-img-meta -->
			...
			=====================================================
			-->
			<div class="team-section-four mt-225 lg-mt-100">
				<div class="container">
					<div class="row align-items-center align-items-xl-end">
						<div class="col-xl-6 col-lg-4 col-md-6 col-sm-8">
							<div class="title-style-nine text-center text-sm-start xs-pb-20">
								<h2 class="title">Our Talented Players.</h2>
							</div>
						</div>
						<div class="col-xl-6 col-lg-8 col-md-6 col-sm-4 d-flex justify-content-center justify-content-sm-end">
							<ul class="slider-arrows product-slider-arrow-one d-flex style-none">
								<li class="prev_team2 slick-arrow ripple-btn" style=""><i class="bi bi-arrow-left"></i></li>
								<li class="next_team2 slick-arrow ripple-btn" style=""><i class="bi bi-arrow-right"></i></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="team_slider_two mt-100 lg-mt-60">
			    	<div class="item">
			    		<div class="team-block-two text-center">
			    			<div class="img-meta"><img src="{{ URL::asset('images/team/img_06.jpg') }}" alt="" class="w-100"></div>
			    			<h4 class="name">Jacob Imulia</h4>
			    			<p>UI Designer</p>
			    		</div> <!-- /.team-block-two -->
			    	</div> <!-- /.item -->
			    	<div class="item">
			    		<div class="team-block-two text-center">
			    			<div class="img-meta"><img src="{{ URL::asset('images/team/img_07.jpg') }}" alt="" class="w-100"></div>
			    			<h4 class="name">Mathus Kabir</h4>
			    			<p>Developer</p>
			    		</div> <!-- /.team-block-two -->
			    	</div> <!-- /.item -->
			    	<div class="item">
			    		<div class="team-block-two text-center">
			    			<div class="img-meta"><img src="{{ URL::asset('images/team/img_08.jpg') }}" alt="" class="w-100"></div>
			    			<h4 class="name">Rashed Ka</h4>
			    			<p>Support Managment</p>
			    		</div> <!-- /.team-block-two -->
			    	</div> <!-- /.item -->
			    	<div class="item">
			    		<div class="team-block-two text-center">
			    			<div class="img-meta"><img src="{{ URL::asset('images/team/img_09.jpg') }}" alt="" class="w-100"></div>
			    			<h4 class="name">Hasan al Said</h4>
			    			<p>Support Lead</p>
			    		</div> <!-- /.team-block-two -->
			    	</div> <!-- /.item -->
			    	<div class="item">
			    		<div class="team-block-two text-center">
			    			<div class="img-meta"><img src="{{ URL::asset('images/team/img_10.jpg') }}" alt="" class="w-100"></div>
			    			<h4 class="name">Nairobi Rao</h4>
			    			<p>Senior Coder</p>
			    		</div> <!-- /.team-block-two -->
			    	</div> <!-- /.item -->
			    	<div class="item">
			    		<div class="team-block-two text-center">
			    			<div class="img-meta"><img src="{{ URL::asset('images/team/img_11.jpg') }}" alt="" class="w-100"></div>
			    			<h4 class="name">Barlin Jio</h4>
			    			<p>Interface Designer</p>
			    		</div> <!-- /.team-block-two -->
			    	</div> <!-- /.item -->
			    </div> <!-- /.team_slider_two -->
			</div> <!-- /.team-section-four -->
			...
			=====================================================
			-->
			<div class="feedback-section-four bg-white lg-mt-20 sm-mt-50">
				<div class="container">
			...
			<div class="blog-section-one">
				<div class="container">
					<div class="border-top pt-120 md-pt-100">
						<div class="row">
							<div class="col-12">
								<div class="row align-items-center">
									...
									<div class="row">
										<div class="col-lg-4 col-md-6 d-flex md-mb-40">
											<article class="blog-meta-one feature-post">
												...
												<div class="post-footer d-flex align-items-center justify-content-between">
													<img src="{{ URL::asset('images/blog/logo_11.png') }}" alt="" class="logo">
										...
										<div class="col-lg-4 col-md-6 d-flex md-mb-40">
											<article class="blog-meta-one feature-post">
												...
												<a href="{{ url('blog.blog-detailsV3') }}" class="title">The StartupGuide to Make Your WordPress dus Journal.</a>
												<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
												<div class="post-footer d-flex align-items-center justify-content-between">
													<img src="{{ URL::asset('images/blog/logo_12.png') }}" alt="" class="logo">
													<a href="{{ url('blog.blog-detailsV3') }}" class="read-more tran3s"><img src="{{ URL::asset('images/icon/icon_16.svg') }}" alt=""></a>
												</div> <!-- /.post-footer -->
											</article> <!-- /.blog-meta-one -->
										</div>
										<div class="col-lg-4 col-md-6 d-flex md-mb-40">
											<article class="blog-meta-one feature-post">
												...
												<a href="{{ url('blog.blog-detailsV3') }}" class="title">Monthly Roundup event December 2019.</a>
												<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
												<div class="post-footer d-flex align-items-center justify-content-between">
													<img src="{{ URL::asset('images/blog/logo_13.png') }}" alt="" class="logo">
													<a href="{{ url('blog.blog-detailsV3') }}" class="read-more tran3s"><img src="{{ URL::asset('images/icon/icon_16.svg') }}" alt=""></a>
												</div> <!-- /.post-footer -->
											</article> <!-- /.blog-meta-one -->
										</div>
			...
			=====================================================
			-->
			<div class="fancy-banner-one mt-170 lg-mt-90">
