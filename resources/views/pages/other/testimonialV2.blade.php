...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			=====================================================
			-->
			<div class="feedback-section-eleven mt-180 lg-mt-120">
				<div class="container">
					<div class="row">
			...
			=====================================================
			-->
			<div class="feedback-section-four mt-170 lg-mt-120">
				<img src="{{ URL::asset('images/shape/shape_09.svg') }}" alt="" class="shapes shape-two">
				<img src="{{ URL::asset('images/shape/shape_45.svg') }}" alt="" class="shapes shape-three">
