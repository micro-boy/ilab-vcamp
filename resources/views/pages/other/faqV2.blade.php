...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-5 col-md-6">
							<h2 class="page-title font-recoleta">Find <span>Answers</span> here.</h2>
						</div>
						<div class="col-xxl-5 col-md-6 ms-auto">
							<p>Lorem ipsum is placeholder text commonly used in the graphic, print, and publishing industries for layouts and visual.</p>
						</div>
					</div>
				</div>
			...
			=====================================================
			-->
			<div class="faq-section-two dark-bg mb-70">
				<div class="container">
					<div class="row">
						<div class="col-xxl-9 col-xl-10 m-auto">
							<ul class="nav nav-tabs justify-content-center" role="tablist">
							  	<li class="nav-item">
							    	<button class="nav-link active" data-bs-toggle="tab" data-bs-target="#all" role="tab">All</button>
							  	</li>
							  	<li class="nav-item" role="presentation">
							    	<button class="nav-link" data-bs-toggle="tab" data-bs-target="#userManual" role="tab">User Manual</button>
							  	</li>
							  	<li class="nav-item" role="presentation">
							    	<button class="nav-link" data-bs-toggle="tab" data-bs-target="#paymnet" role="tab">Payments</button>
							  	</li>
							  	<li class="nav-item" role="presentation">
							    	<button class="nav-link" data-bs-toggle="tab" data-bs-target="#account" role="tab">Account</button>
							  	</li>
							  	<li class="nav-item" role="presentation">
							    	<button class="nav-link" data-bs-toggle="tab" data-bs-target="#terms-conditions" role="tab">Terms & Conditions</button>
							  	</li>
							</ul>


							<div class="tab-content mt-110 lg-mt-60">
							  	<div class="tab-pane fade show active" id="all" role="tabpanel">
							  		<div class="accordion accordion-style-three" id="accordionTwo">
										<div class="accordion-item">
										    ...
										    <div id="collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionTwo">
										    	<div class="accordion-body">
										        	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip visual sed.</p>
										    	</div>
										    </div>
									  	</div>
									  	<div class="accordion-item">
									  	...
									  	<div class="accordion-item">
										    ...
										    <div id="collapseThree" class="accordion-collapse collapse show" data-bs-parent="#accordionTwo">
										    	<div class="accordion-body">
										        	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip visual sed.</p>
										    	</div>
										    </div>
									...
									</div> <!-- /.accordion-style-three -->
							  	</div>
							  	<div class="tab-pane fade" id="userManual" role="tabpanel">
							  		<div class="accordion accordion-style-three" id="accordionThree">
										<div class="accordion-item">
							  	...
							  	<div class="tab-pane fade" id="paymnet" role="tabpanel">
							  		<div class="accordion accordion-style-three" id="accordionFour">
									  	<div class="accordion-item">
							  	...
							  	<div class="tab-pane fade" id="account" role="tabpanel">
							  		<div class="accordion accordion-style-three" id="accordionFive">
										<div class="accordion-item">
							  	...
							  	<div class="tab-pane fade" id="terms-conditions" role="tabpanel">
							  		<div class="accordion accordion-style-three" id="accordionSix">
										<div class="accordion-item">
							...
							<div class="request-faq text-center pt-90 lg-pt-70">
								<h2 class="font-recoleta">Don’t get your answer?</h2>
								<a href="{{ url('pages.support.contactV3') }}" class="theme-btn-four ripple-btn">CONTACT US</a>
							</div> <!-- /.request-faq -->
						</div>
					</div>
				</div> <!-- /.container -->
