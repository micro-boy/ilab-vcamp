...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			=====================================================
			-->
			<div class="feedback-section-ten dark-bg">
				<div class="container">
					<div class="row">
						...
						<div class="text-center mt-70 lg-mt-30"><a href="#" class="theme-btn-four ripple-btn">Lore More</a></div>
					</div> <!-- /.row -->
				</div> <!-- /.container -->
				<img src="{{ URL::asset('images/shape/shape_38.svg') }}" alt="" class="shapes shape-four">
