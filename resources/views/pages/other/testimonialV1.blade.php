		...
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-three">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<h2 class="page-title font-recoleta">Trusted <span>Client</span> Feedback</h2>
						</div>
			...
			<div class="box-layout">
				<div class="feedback-section-ten light-bg">
					<div class="inner-container">
						<div class="row">
							...
							<div class="col-xl-4 col-sm-6" data-aos="fade-up" data-aos-delay="150">
								<div class="testimonial-block-one mb-40">
									<div class="icon d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/icon/icon_15.svg') }}" alt=""></div>
									<blockquote>
										Certainly from my perspective been a great success with WP giving us that enterprises level assured quality.
						...
						<div class="text-center mt-70 lg-mt-30"><a href="#" class="theme-btn-two ripple-btn">Lore More</a></div>
					</div> <!-- /.inner-container -->
					<img src="{{ URL::asset('images/shape/shape_42.svg') }}" alt="" class="shapes shape-one">
					<img src="{{ URL::asset('images/shape/shape_43.svg') }}" alt="" class="shapes shape-two">
					<img src="{{ URL::asset('images/shape/shape_44.svg') }}" alt="" class="shapes shape-three">
			...
			=====================================================
			-->
			<div class="fancy-banner-seven mb-100 lg-mb-60" data-aos="fade-up">
				<div class="container">
