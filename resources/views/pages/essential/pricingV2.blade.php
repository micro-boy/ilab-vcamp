...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="inside-hero-five">
				<div class="container">
					<div class="row">
						<div class="col-xxl-5 col-lg-6 col-md-8">
							<div class="title-style-one">
								<div class="upper-title mb-25 lg-m0">Pricing</div>
								<h2 class="title">We have <br>varied <span>packages</span> for you.</h2>
							</div>
							<p class="text-lg pt-50 lg-pt-30">vCamp delivered blazing fast performance, striking wordPress soludtion</p>
						</div>
						<div class="col-xxl-7 col-lg-6 col-md-4">
							<img src="{{ URL::asset('images/assets/ils_02.svg') }}" alt="" class="illustration sm-mt-30">
						</div>
					</div>
				</div>
			</div> <!-- /.inside-hero-five -->
			...
			=====================================================
			-->
			<div class="pricing-section-one dark-bg">
				<img src="{{ URL::asset('images/shape/shape_33.svg') }}" alt="" class="shapes shape-one">
				<div class="container">
					<div class="row">
						<div class="col-xxl-9 col-xl-10 col-lg-8 col-md-10 m-auto">
							<div class="title-style-one white-vr text-center">
			...
			=====================================================
			-->
			<div class="fancy-banner-six reverse-space mb-70">
				<div class="container position-relative">
					<img src="{{ URL::asset('images/shape/shape_34.svg') }}" alt="" class="shapes shape-one">
					<div class="inner-content position-relative">
						<div class="row align-items-center">
							...
							<div class="col-xxl-4 col-lg-3 text-center text-lg-end">
								<a href="{{ url('pages.support.contactV2') }}" class="theme-btn-four ripple-btn md-mt-30">Contact us</a>
							</div>
						</div>
					</div>
				</div>
