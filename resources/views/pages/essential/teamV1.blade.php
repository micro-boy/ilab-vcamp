	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-one hero-spacing">
				<div class="container">
					<h2 class="page-title font-recoleta">Our Team</h2>
			...
			=====================================================
			-->
			<div class="team-section-two mt-160 lg-mt-120">
				<div class="container">
					<div class="controls control-nav-two text-center mb-30 lg-mb-10">
				        <button type="button" class="control" data-filter="all">All</button>
				        <button type="button" class="control" data-filter=".dev">Developer</button>
				        <button type="button" class="control" data-filter=".designer">Designer</button>
				        <button type="button" class="control" data-filter=".support">Support</button>
			    	</div>
			...
			=====================================================
			-->
			<div class="fancy-banner-five mt-150 mb-80 lg-mt-120 lg-mb-40">
				<div class="container">
					<div class="row">
						<div class="col-12 m-auto">
							<div class="bg-wrapper">
								...
								<a href="{{ url('pages.support.contactV1') }}" class="theme-btn-four ripple-btn">Send your CV</a>
							</div>
						</div>
					</div>
				</div>
