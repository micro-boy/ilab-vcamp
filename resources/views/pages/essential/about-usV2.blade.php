	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="vcamp-feature-section-six mt-150 lg-mt-70">
							...
							<div class="row">
								<div class="col-md-6" data-aos="fade-up">
									<div class="card-style-six">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_46.svg') }}" alt=""></div>
								...
								<div class="col-md-6" data-aos="fade-up">
									<div class="card-style-six">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_47.svg') }}" alt=""></div>
								...
								<div class="col-md-6" data-aos="fade-up" data-aos-delay="100">
									<div class="card-style-six">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_48.svg') }}" alt=""></div>
										<h4>Great Pricing</h4>
										<p>Elit esse cillum dolore eu fugiat nulla pariatur</p>
									</div> <!-- /.card-style-six -->
								</div>
								<div class="col-md-6" data-aos="fade-up" data-aos-delay="200">
									<div class="card-style-six">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_49.svg') }}" alt=""></div>
										<h4>100% Trusted</h4>
										<p>Elit esse cillum dolore eu fugiat nulla pariatur</p>
									</div> <!-- /.card-style-six -->
								</div>
				...
				<img src="{{ URL::asset('images/shape/shape_25.svg') }}" alt="" class="shapes shape-one">
				<img src="{{ URL::asset('images/shape/shape_26.svg') }}" alt="" class="shapes shape-two">
			...
			<div class="feedback-section-four bg-white mt-60">
				<img src="{{ URL::asset('images/shape/shape_27.svg') }}" alt="" class="shapes shape-five">
				<div class="container">
			...
			<div class="partner-slider-one border-top pt-60 mt-30 mb-70 lg-mt-10">
				<div class="container">
					...
					<div class="partnerSliderOne">
						<div class="item">
							<div class="img-meta d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/logo/logo-18.png') }}" alt=""></div>
						</div>
						<div class="item">
							<div class="img-meta d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/logo/logo-19.png') }}" alt=""></div>
						</div>
						<div class="item">
							<div class="img-meta d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/logo/logo-20.png') }}" alt=""></div>
						</div>
						<div class="item">
							<div class="img-meta d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/logo/logo-21.png') }}" alt=""></div>
						</div>
						<div class="item">
							<div class="img-meta d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/logo/logo-22.png') }}" alt=""></div>
						</div>
						<div class="item">
							<div class="img-meta d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/logo/logo-23.png') }}" alt=""></div>
						</div>
					</div>
				</div>
