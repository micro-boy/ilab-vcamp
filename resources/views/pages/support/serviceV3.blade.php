		...
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-three">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
							<h2 class="page-title font-recoleta"><span>Solutions</span> we provide.</h2>
						</div>
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-three dark-bg">
				<img src="{{ URL::asset('images/shape/shape_40.svg') }}" alt="" class="shapes shape-one">
				<div class="container">
					<div class="row">
						<div class="col-xl-4" data-aos="fade-right">
							<div class="service-title mt-100 lg-mt-40 lg-mb-60">Development</div>
						</div>
						<div class="col-xl-4 col-sm-6">
							<div class="card-style-three mb-100 lg-mb-50" data-aos="fade-up">
					...
					<div class="row">
						<div class="col-xl-4" data-aos="fade-right">
							<div class="service-title mt-5 lg-mb-60">Industrial</div>
						</div>
						<div class="col-xl-4 col-sm-6" data-aos="fade-up">
							<div class="card-style-seven mb-60 lg-mb-50">
								<h4>Enterprise Service</h4>
								<p>Take a deep dive and try <span>list of over 40</span> unique <span>generators</span> find placehor images for your next</p>
			...
			=====================================================
			-->
			<div class="fancy-banner-four mb-70 lg-mb-40 sm-mb-60">
				<div class="container position-relative">
					<img src="{{ URL::asset('images/shape/shape_41.svg') }}" alt="" class="shapes shape-one">
					<div class="bg-wrapper">
						<div class="col-xl-10 col-md-11 m-auto">
							<div class="row">
								<div class="row align-items-center">
									<div class="col-xl-7 col-md-8">
										<h2 class="title font-recoleta text-center text-md-start">Have any <span>project</span> <br> in mind?</h2>
									</div>
									<div class="col-xl-5 col-md-4 d-flex justify-content-md-end justify-content-center">
