	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-two" style="background-image: url(images/media/img_46.jpg);">
				<div class="container">
					<h2 class="page-title">Solutions</h2>
					<p>We’re empowering WordPress to do great things together</p>
				</div>
				<img src="{{ URL::asset('images/shape/shape_38.svg') }}" alt="" class="shapes shape-one">
			</div> <!-- /.inside-hero-two -->
						...
						<div class="col-xxl-11 m-auto">
							<div class="row align-items-center mb-80 lg-mb-20">
								...
								<div class="col-lg-5 col-md-6 ms-auto">
									<p class="text-lg theme-mb-0 sm-mt-20">Lorem ipsum dolor sit amet, consecte adiel sed do eiusmod tempor incidi ut labore split</p>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-lg-4 col-sm-6" data-aos="fade-up">
									<div class="card-style-eight">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_55.svg') }}" alt=""></div>
										<h4>Core WP</h4>
								...
								<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-delay="100">
									<div class="card-style-eight">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_56.svg') }}" alt=""></div>
								...
								<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-delay="150">
									<div class="card-style-eight">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_57.svg') }}" alt=""></div>
										<h4>Customization</h4>
								...
								<div class="col-lg-4 col-sm-6" data-aos="fade-up">
									<div class="card-style-eight">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_58.svg') }}" alt=""></div>
										<h4>Marketing</h4>
								...
								<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-delay="100">
									<div class="card-style-eight">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_59.svg') }}" alt=""></div>
										<h4>e-Commerce</h4>
										<p>Duis aute irure dolor  reprehen derit in voluptat velit.</p>
									</div> <!-- /.card-style-eight -->
								</div>
								<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-delay="150">
									<div class="card-style-eight">
										<div class="icon d-flex align-items-end"><img src="{{ URL::asset('images/icon/icon_60.svg') }}" alt=""></div>
										<h4>Platform Audit</h4>
										<p>Duis aute irure dolor  reprehen derit in voluptat velit.</p>
									</div> <!-- /.card-style-eight -->
								</div>
							</div>
			...
			<div class="vcamp-feature-section-seven style-two mt-225 lg-mt-120">
					...
					<div class="row">
						<div class="col-xxl-7 col-xl-9 col-lg-7 col-md-9 m-auto" data-aos="fade-up">
							<div class="title-style-five text-center">
								<h2 class="title">We provide industrial solution also</h2>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="row">
								<div class="col-md-4 col-sm-6 d-flex mt-45" data-aos="fade-up">
									<div class="card-style-seven">
										<div class="icon d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/icon/icon_61.svg') }}" alt=""></div>
										<h4>Media & Publishing</h4>
										<p>Placeholder text commonly used in print, & <span>publishing</span> industries for <span>previewing</span> layouts and visual <span>mockups</span></p>
									</div> <!-- /.card-style-seven -->
								</div>
								<div class="col-md-4 col-sm-6 d-flex mt-45" data-aos="fade-up" data-aos-delay="100">
									<div class="card-style-seven">
										<div class="icon d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/icon/icon_62.svg') }}" alt=""></div>
										<h4>Technology</h4>
										<p>eiusmod tempor <span>incididunt</span> ut labore et dolore <span>magnaliq</span>. Ut enim ad minimveniam</p>
									</div> <!-- /.card-style-seven -->
								</div>
								<div class="col-md-4 col-sm-6 d-flex mt-45" data-aos="fade-up" data-aos-delay="150">
									<div class="card-style-seven">
										<div class="icon d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/icon/icon_63.svg') }}" alt=""></div>
				...
				<img src="{{ URL::asset('images/shape/shape_39.svg') }}" alt="" class="shapes shape-three">
				<img src="{{ URL::asset('images/shape/shape_37.svg') }}" alt="" class="shapes shape-two">
			...
			=====================================================
			-->
			<div class="feedback-section-four bg-white mt-30">
				<div class="container">
			...
			=====================================================
			-->
			<div class="fancy-banner-seven border-top">
				<div class="container">
					<div class="inner-content bg-white position-relative">
						<div class="row align-items-center">
							<div class="col-xl-8 col-lg-9">
								<h3 class="font-recoleta">Have any project in mind?</h3>
								<p>Call <a href="#">+88 2734 677 12</a> or email us at <a href="#">support@vcamp.com</a></p>
							</div>
							<div class="col-xl-4 col-lg-3 text-xl-end">
								<a href="{{ url('pages.support.contactV1') }}" class="theme-btn-four ripple-btn">Let’s Discuss</a>
							</div>
						</div>
					</div>
				</div>
										...
										<div class="col-md-6">
											<div class="subscribe-form">
												<form action="#">
													...
													<button class="ripple-btn bg-two">Join <img src="{{ URL::asset('images/icon/icon_20.svg') }}" alt="" class="ms-2 d-inline-block"></button>
												</form>
								...
								<div class="top-footer mt-60 md-mt-30">
									<div class="row">
										<div class="col-lg-4 col-md-2 d-flex justify-content-between flex-column">
											<div class="logo"><a href="{{ url('home.index') }}"><img src="{{ URL::asset('images/logo/vCamp_05.svg') }}" alt=""></a></div>
