	...
	<body>
		<div class="main-page-wrapper">
			...
			<div class="inside-hero-three bg-color">
				<img src="{{ URL::asset('images/shape/shape_35.svg') }}" alt="" class="shapes shape-one">
				<div class="container">
					<div class="row">
						<div class="col-md-6">
			...
			<div class="vcamp-feature-section-three mt-200 lg-mt-80">
				<div class="container">
					...
					<div class="row">
						<div class="col-xl-4" data-aos="fade-right">
							<div class="service-title mt-100 lg-mt-40 lg-mb-40">Marketing</div>
						</div>
						<div class="col-xl-4 col-sm-6" data-aos="fade-up">
							<div class="card-style-three mb-100 lg-mb-50">
			...
			<div class="vcamp-feature-section-seven mt-70">
					...
					<div class="row">
						<div class="col-xxl-7 col-xl-8 col-lg-6 col-md-8 m-auto" data-aos="fade-up">
							<div class="title-style-one text-center">
								<h2 class="title">We provide <span>industrial</span> solution also</h2>
							</div>
						</div>
					</div>
				</div>
				...
				<img src="{{ URL::asset('images/shape/shape_36.svg') }}" alt="" class="shapes shape-one">
			...
			=====================================================
			-->
			<div class="fancy-banner-seven mt-20 mb-100 lg-mb-60" data-aos="fade-up">
				<div class="container">
