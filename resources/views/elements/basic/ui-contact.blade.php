...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="vcamp-text-block-one pt-180 md-pt-120 pb-80">
				<div class="container">
					<div class="row">
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								...
								<p class="meta-info-text text-lg">Use <code>id="contact-form"</code> and <code>data-toggle="validator"</code> into <code>form</code> tag to active the form into your page.</p>
								<a href="{{ url('elements.essential.ui-counter') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			=====================================================
			-->
			<div class="contact-section-two light-bg pt-130 pb-170 lg-pt-100 lg-pb-100">
								...
								<div class="form-style-one with-border md-mt-40">
									<form  action="inc/contact.php" >
										...
										<div class="row controls">
											...
											<div class="col-12"><button class="theme-btn-one xs w-100">Send Message</button></div>
										</div>
									</form>
									...
									<form action="inc/contact.php" >
										...
										<div class="row controls">
											...
											<div class="col-12">
												<div class="input-group-meta form-group mb-40">
													<label>Phone*</label>
													<input id="phone" name="phone" placeholder="+1-202-555-0103" type="tel" required="required" data-error="Phone is required.">
													<div class="help-block with-errors"></div>
												</div>
											</div>
											<div class="col-12">
			...
			============================================== 
			-->
			<div class="contact-section-six mt-140 mb-120 lg-mt-120">
				<div class="container">
					<div class="title-style-two text-center pb-100 lg-pb-70">
						<h2 class="title">Get in Touch</h2>
						<p class="pt-10">Get our all info and also can message us directly from here</p>
					</div>
					<div class="row align-items-center">
						<div class="col-md-6">
						...
						<div class="col-lg-5 col-md-6 ms-auto">
							<div class="address-block-three d-flex mb-80 lg-mb-40">
								<div class="icon"><img src="{{ URL::asset('images/icon/icon_17.svg') }}" alt=""></div>
								<div class="text">
							...
							<div class="address-block-three d-flex mb-80 lg-mb-40">
								<div class="icon"><img src="{{ URL::asset('images/icon/icon_18.svg') }}" alt=""></div>
								<div class="text">
							...
							<div class="address-block-three d-flex">
								<div class="icon"><img src="{{ URL::asset('images/icon/icon_19.svg') }}" alt=""></div>
								<div class="text">
									<h5 class="title">Live Support</h5>
									<p>Urgent go to live chat portal  <br><a href="#" class="webaddress">www.supportlive.com</a></p>
								</div>
							</div> <!-- /.address-block-three -->
						</div>
					</div>
			...
			============================================== 
			-->
			<div class="contact-section-four pt-100 pb-120 border-top">
				<div class="container">
				...
				<div class="container">
					<div class="row">
						<div class="col-xl-11 m-auto">
							<div class="form-style-one m0 border0">
								<form action="inc/contact.php">
									<div class="messages"></div>
									<div class="row controls">
										<div class="col-sm-6">
										...
										<div class="col-sm-6">
											<div class="input-group-meta form-group mb-25">
												...
												<input type="text" placeholder="Kabir" name="name" required="required" data-error="Name is required.">
												<div class="help-block with-errors"></div>
											</div>
										</div>
										<div class="col-12">
