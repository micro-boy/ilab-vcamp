						...
						<nav class="navbar navbar-expand-lg">
						    ...
						    <div class="collapse navbar-collapse" id="navbarNav">
						    	<ul class="navbar-nav">
						            ...
						            <li class="nav-item active dropdown icon-menu">
							        	<a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">Icon Menu</a>
						                <ul class="dropdown-menu">
							                <li>
							                	<div class="d-flex">
							                		<div class="icon"><img src="{{ URL::asset('images/icon/menu_icon_06.svg') }}" alt=""></div>
							                		<div class="ps-3">
							                			<a href="#" class="page-title">About us</a>
							                			<span class="xs-text">Learn about our <a href="{{ url('pages.essential.about-usV1') }}">Agency</a> and <a href="{{ url('pages.essential.teamV1') }}">Team</a> </span>
							                		</div>
							                	</div>
							                </li>
							                <li>
							                	<div class="d-flex">
							                		<div class="icon"><img src="{{ URL::asset('images/icon/menu_icon_02.svg') }}" alt=""></div>
							                		<div class="ps-3">
							                			<a href="#" class="page-title">Case Study</a>
							                			<span class="xs-text">Find details about <a href="{{ url('portfolio.boxed_layout.portfolioV1') }}">our project</a></span>
							                		</div>
							                	</div>
							                </li>
							                <li>
							                	<div class="d-flex">
							                		<div class="icon"><img src="{{ URL::asset('images/icon/menu_icon_05.svg') }}" alt=""></div>
							                		<div class="ps-3">
							                			<a href="#" class="page-title">Services</a>
							                			<span class="xs-text">Discover all our <a href="{{ url('pages.support.serviceV1') }}">services</a> & <a href="{{ url('pages.support.serviceV1') }}">Features</a></span>
							                		</div>
							                	</div>
							                </li>
							                <li>
							                	<div class="d-flex">
							                		<div class="icon"><img src="{{ URL::asset('images/icon/menu_icon_01.svg') }}" alt=""></div>
							                		<div class="ps-3">
							                			<a href="#" class="page-title">Get Help</a>
							                			<span class="xs-text">Find our <a href="{{ url('pages.other.faqV1') }}">documentation</a> and <a href="{{ url('pages.other.faqV1') }}">FAQs</a></span>
							                		</div>
							                	</div>
							                </li>
							                <li>
							                	<div class="d-flex">
							                		<div class="icon"><img src="{{ URL::asset('images/icon/menu_icon_04.svg') }}" alt=""></div>
							                		<div class="ps-3">
							                			<a href="#" class="page-title">Contact</a>
							                			<span class="xs-text">Find our <a href="#">Live chat</a>, <a href="#">hotline</a>, <a href="#">email</a> add & <a href="#">Office Address</a></span>
							                		</div>
							                	</div>
							                </li>
						                </ul>
					...
					<div class="row">
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								...
								<a href="{{ url('elements.content.ui-pagination') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
