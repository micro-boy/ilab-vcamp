	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title"><span>Buttons</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.basic.ui-contact') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="buttons-style">
				<h4 class="text-center font-recoleta fw-bold pt-80 pb-80">Theme Buttons</h4>
				<div class="container">
					<div class="row">
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Platform Audit</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-one">
								Primary Button
								<img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt="">
							</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Platform Audit</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-two">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Core WordPress</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-three">Primary Button <i class="fas fa-angle-right"></i></a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Marketing</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-four">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">e-Commerce</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-five position-relative">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Core WordPress</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-six">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Platform Audit</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-seven">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Marketing</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-eight">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Core WordPress</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-nine">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Platform Audit</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-eleven">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">Marketing</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-twelve">Primary Button</a>
						</div>
						<div class="col-lg-4 col-sm-6 mb-100">
							<h4 class="font-recoleta fw-bold">e-Commerce</h4>
							<p class="fs-6 mb-40 mt-20 pe-xl-5 me-xl-3">Having a home based business makes wonderful asset to your life. The WordPress VIP stands it comes.</p>
							<a href="#" class="theme-btn-thirteen">Primary Button</a>
						</div>
					</div>
				</div>
			</div> <!-- /.buttons-style -->
