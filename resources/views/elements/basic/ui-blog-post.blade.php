...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Blog <span>Post</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.basic.ui-button') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			=====================================================
			-->
			<div class="blog-section-one mt-100 lg-mt-40">
				<div class="container">
			...
			=====================================================
			-->
			<div class="blog-section-two mt-120 pt-100 border-top">
				<div class="container">
					<div class="row">
			...
			=====================================================
			-->
			<div class="blog-section-six dark-bg mt-120">
				<div class="container">
			...
			<div class="blog-section-four mt-160 mb-150 lg-mt-100 lg-mb-120">
				<div class="container">
					<div class="title-style-one text-center pb-100 lg-pb-50">
						<h3 class="title">Blog</h3>
						<p class="text-lg pt-20">Find stories from our community members</p>
					</div>
					<div class="row">
						<div class="col-12">
							<div class="row gx-xl-5">
								<div class="col-lg-4 col-md-6">
									<article class="blog-meta-four">
										<div class="img-meta position-relative">
											<img src="{{ URL::asset('images/blog/blog_img_04.jpg') }}" alt="" class="w-100">
								...
								<div class="col-lg-4 col-md-6">
									<article class="blog-meta-four">
										<div class="img-meta position-relative">
											<img src="{{ URL::asset('images/blog/blog_img_06.jpg') }}" alt="" class="w-100">
											<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
										</div>
										<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
										<a href="{{ url('blog.blog-detailsV3') }}" class="title">Make more productive working flow daily.</a>
										<div class="post-footer d-flex align-items-center justify-content-between">
								...
								<div class="col-lg-4 col-md-6">
									<article class="blog-meta-four">
										<div class="img-meta position-relative">
											<img src="{{ URL::asset('images/blog/blog_img_05.jpg') }}" alt="" class="w-100">
											<a href="{{ url('blog.blog-detailsV3') }}" class="tag">Soltuion</a>
										</div>
										<div class="post-info">Featured - <span class="date">18 Jul 20</span></div>
										<a href="{{ url('blog.blog-detailsV3') }}" class="title">Designer’s Checklist for Every UX Project.</a>
										<div class="post-footer d-flex align-items-center justify-content-between">
											<img src="{{ URL::asset('images/blog/logo_06.png') }}" alt="" class="logo">
											<a href="{{ url('blog.blog-detailsV3') }}" class="read-more tran3s"><img src="{{ URL::asset('images/icon/icon_16.svg') }}" alt=""></a>
										</div>
