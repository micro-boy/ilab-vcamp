...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Text <span>Animation</span></h3>
								</div>
								<p class="meta-info-text text-lg">Please Note: You must add <code>animated-headline-master</code> js to use this animation.</p>
								<a href="{{ url('elements.basic.ui-blog-post') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			============================================== 
			-->
			<div class="animated-text mt-120">
				<div class="container">
					<div class="container">
						<h4 class="text-center font-recoleta fw-bold pb-50">Rotate Style</h4>
						<div class="row">
							<div class="col-12">
								<div class="title-style-ten text-center">
									<h2 class="title cd-headline rotate-1">
										vCamp known as WordPress
										<span class="cd-words-wrapper">
								         	<b class="is-visible">guru</b>
								         	<b>expert</b>
								      </span>
									</h2>
								</div>
			...
			<div class="animated-text border-top mt-100 pt-80">
				<div class="container">
					<div class="container">
						<h4 class="text-center font-recoleta fw-bold pb-50">Rotate Style Two</h4>
						<div class="row">
							<div class="col-12">
								<div class="title-style-ten text-center">
									<h2 class="title cd-headline letters rotate-2">
										vCamp known as WordPress
										<span class="cd-words-wrapper">
								         	<b class="is-visible">demon</b>
								         	<b>expert</b>
								      </span>
									</h2>
								</div>
			...
			<div class="animated-text border-top mt-100 pt-80">
				<div class="container">
					<div class="container">
						<h4 class="text-center font-recoleta fw-bold pb-50">Loading-bar Style</h4>
						<div class="row">
							<div class="col-12">
								<div class="title-style-ten text-center">
									<h2 class="title cd-headline loading-bar">
										vCamp known as WordPress
										<span class="cd-words-wrapper">
								         	<b class="is-visible">demon</b>
								         	<b>expert</b>
			...
			<div class="animated-text border-top mt-100 pt-80">
				<div class="container">
					<div class="container">
						<h4 class="text-center font-recoleta fw-bold pb-50">Slide Style</h4>
						<div class="row">
							<div class="col-12">
								<div class="title-style-ten text-center">
			...
			<div class="animated-text border-top mt-100 pt-80">
				<div class="container">
					<div class="container">
						<h4 class="text-center font-recoleta fw-bold pb-50">Clip Style</h4>
						<div class="row">
							<div class="col-12">
								<div class="title-style-ten text-center">
			...
			<div class="animated-text border-top mt-100 pt-80">
				<div class="container">
					<div class="container">
						<h4 class="text-center font-recoleta fw-bold pb-50">Zoom Style</h4>
						<div class="row">
							<div class="col-12">
								<div class="title-style-ten text-center">
									<h2 class="title cd-headline zoom">
										vCamp known as WordPress
										<span class="cd-words-wrapper">
								         	<b class="is-visible">expert</b>
								         	<b>demon</b>
			...
			<div class="animated-text border-top mt-100 pt-80">
				<div class="container">
					<div class="container">
						<h4 class="text-center font-recoleta fw-bold pb-50">Rotate Style Three</h4>
						<div class="row">
							<div class="col-12">
								<div class="title-style-ten text-center">
									<h2 class="title cd-headline letters rotate-3">
										vCamp known as WordPress
										<span class="cd-words-wrapper">
								         	<b class="is-visible">expert</b>
								         	<b>demon</b>
			...
			============================================== 
			-->
			<div class="animated-text border-top mt-100 pt-80 pb-100">
				<div class="container">
					<div class="container">
						<h4 class="text-center font-recoleta fw-bold pb-50">Scale Style</h4>
						<div class="row">
							<div class="col-12">
								<div class="title-style-ten text-center">
									<h2 class="title cd-headline letters scale">
										vCamp known as WordPress
										<span class="cd-words-wrapper">
								         	<b class="is-visible">demon</b>
								         	<b>expert</b>
