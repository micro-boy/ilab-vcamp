...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="offcanvas offcanvas-top sidebar-nav full-screen dark-style" tabindex="-1" id="offcanvasTop">
				<div class="offcanvas-header justify-content-end">
				    <button type="button" class="close-btn tran3s" data-bs-dismiss="offcanvas" aria-label="Close"><i class="bi bi-x-lg"></i></button>
				</div>
			  	
			  	<div class="sidebar-nav-item m-auto">
			  		<ul class="style-none">
			  			<li class="nav-item">
			  				...
			  				<ul class="dropdown-menu">
							    <li><a href="{{ url('home.index') }}" class="dropdown-item"><span>Business</span></a></li>
							    <li><a href="{{ url('home.index-2') }}" class="dropdown-item"><span>Creative Agency</span></a></li>
			  			...
			  			<li class="nav-item dropdown">
						    ...
						    <ul class="dropdown-menu">
					            <li><a href="{{ url('portfolio.boxed_layout.portfolioV1') }}" class="dropdown-item"><span>Basic Grid</span></a></li>
					            <li><a href="{{ url('portfolio.full-width_layout.portfolioV2') }}" class="dropdown-item"><span>Creative Layout</span></a></li>
					            <li><a href="{{ url('portfolio.dark_layout.portfolioV3') }}" class="dropdown-item"><span>Color Overlay Dark</span></a></li>
					            <li><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}" class="dropdown-item"><span>Deatils: Dark Layout</span></a></li>
						    </ul>
						</li>
			  			<li class="nav-item">
				...
				<div class="inner-content">
					<div class="d-flex align-items-center justify-content-between">
						...
						<div class="right-widget d-flex align-items-center">
							<button class="sidebar-nav-button" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop" aria-controls="offcanvasTop"><img src="{{ URL::asset('images/icon/icon_70.svg') }}" alt=""></button>
						</div> <!-- /.right-widget -->
					</div>
				</div> <!-- /.inner-content -->
			...
			============================================== 
			-->
			<div class="vcamp-text-block-one pt-160 pb-80 md-pt-120 dark-bg">
				<div class="container">
					<div class="row">
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two white-vr">
									<h3 class="title">Full Screen <span>Menu Dark</span></h3>
								</div>
								<p class="meta-info-text text-lg text-white">We all know that developing a creative DIY pocket-friendly website is not so easy.</p>
								<a href="{{ url('elements.basic.ui-menuV3') }}" class="theme-btn-four ripple-btn">Next Menu</a>
							</div>
						</div>
					</div>
				</div>
