...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="vcamp-text-block-one pt-180 md-pt-120 pb-80 dark-bg">
				<div class="container">
					<div class="row">
						<div class="col-xxl-8 col-lg-9 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two white-vr">
									<h3 class="title">eCommerce <span>Dark Header</span></h3>
								</div>
								...
								<a href="{{ url('elements.headers.ui-headerV7') }}" class="theme-btn-four ripple-btn">Next Header</a>
							</div>
						</div>
					</div>
				</div>
