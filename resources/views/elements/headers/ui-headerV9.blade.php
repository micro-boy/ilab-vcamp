...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper light-bg">
			...
			============================================== 
			-->
			<div class="hero-banner-two h-100">
				<div class="container">
					<div class="vcamp-text-block-one pb-100">
						<div class="row">
							<div class="col-xxl-7 col-lg-8 m-auto">
								<div class="text-center">
									<div class="title-style-two">
										<h3 class="title">Search Popup <span>Header</span></h3>
									</div>
									<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
									<a href="{{ url('elements.essential.ui-heading') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
								</div>
							</div>
						</div>
