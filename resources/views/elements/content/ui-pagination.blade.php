...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title"><span>Pagination</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.content.ui-service') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			============================================== 
			-->
			<div class="page-pagination-one pt-60 pb-60 border-bottom">
				<h4 class="text-center font-recoleta fw-bold pb-40">Default Style</h4>
				<div class="container">
			...
			============================================== 
			-->
			<div class="page-pagination-two pt-60 pb-60 border-bottom">
				<h4 class="text-center font-recoleta fw-bold pb-40">Round Icon Style</h4>
				<div class="container">
					<ul class="d-flex align-items-center justify-content-center style-none">
						<li class="arrow"><a href="#"><i class="bi bi-arrow-left"></i></a></li>
						<li class="arrow active"><a href="#"><i class="bi bi-arrow-right"></i></a></li>
					</ul>
				</div>
			</div>
			...
			============================================== 
			-->
			<div class="page-pagination-three pt-60 pb-60 border-bottom">
				<h4 class="text-center font-recoleta fw-bold pb-40">Minimal Style</h4>
				<div class="container">
					<ul class="d-flex align-items-center justify-content-center style-none">
						<li><a href="#">1</a></li>
						<li class="active"><a href="#">2</a></li>
						<li><a href="#">3</a></li>
						<li class="arrow"><a href="#"><i class="bi bi-chevron-right"></i></a></li>
					</ul>
				</div>
			</div>
			...
			============================================== 
			-->
			<div class="page-pagination-four pt-60 pb-60 border-bottom">
				<h4 class="text-center font-recoleta fw-bold pb-40">Icon With Text Style</h4>
				<div class="container">
					<div class="row">
						<div class="col-xxl-4 col-xl-5 col-md-6 m-auto">
							<ul class="d-flex align-items-center justify-content-between style-none">
								<li class="d-flex align-items-center">
									<a href="#" class="icon"><i class="bi bi-arrow-left"></i></a>
									<span class="ps-3">Previous</span>
								</li>
								<li class="d-flex align-items-center active">
									<span class="pe-3">Next</span>
									<a href="#" class="icon"><i class="bi bi-arrow-right"></i></a>
								</li>
							</ul>
						</div>
					</div>
			...
			============================================== 
			-->
			<div class="page-pagination-one round-style pt-60 pb-60 border-bottom">
				<h4 class="text-center font-recoleta fw-bold pb-40">Default Round Style</h4>
				<div class="container">
					<ul class="d-flex align-items-center justify-content-center style-none">
