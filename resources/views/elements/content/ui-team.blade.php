	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Team <span>Member</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.content.ui-testimonial') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="team-section-two">
				<h4 class="text-center font-recoleta fw-bold pt-80">Basic Grid Style</h4>
				<div class="container">
			    	<div class="mixitUp-container">
			    		...
			    		<div class="mix designer support">
			    			<div class="team-block-two text-center">
			...
			<div class="team-section-five border-top mt-130 md-mt-100 pt-80">
				<h4 class="text-center font-recoleta fw-bold pb-30">Basic Dark Style</h4>
				<div class="container">
					<div class="row">
						<div class="col-lg-3 col-sm-6">
							<div class="team-block-four text-center mt-40">
								<div class="img-meta"><img src="{{ URL::asset('images/team/img_22.jpg') }}" alt="" class="w-100"></div>
								<p>Owner & Founder</p>
								<h4 class="name">Rashed ul Kabir</h4>
							</div> <!-- /.team-block-four -->
						</div>
						<div class="col-lg-3 col-sm-6">
							<div class="team-block-four text-center mt-40">
								<div class="img-meta"><img src="{{ URL::asset('images/team/img_23.jpg') }}" alt="" class="w-100"></div>
								<p>Project Manager</p>
								<h4 class="name">Jubayer Hasan</h4>
							</div> <!-- /.team-block-four -->
						</div>
						<div class="col-lg-3 col-sm-6">
							<div class="team-block-four text-center mt-40">
								<div class="img-meta"><img src="{{ URL::asset('images/team/img_24.jpg') }}" alt="" class="w-100"></div>
						...
						<div class="col-lg-3 col-sm-6">
							<div class="team-block-four text-center mt-40">
								<div class="img-meta"><img src="{{ URL::asset('images/team/img_25.jpg') }}" alt="" class="w-100"></div>
								<p>UI Design</p>
								<h4 class="name">Hera Rahman</h4>
							</div> <!-- /.team-block-four -->
						</div>
					</div>
				</div>
			...
			=====================================================
			-->
			<div class="team-section-one dark-bg pb-5 mt-150 lg-mt-100">
				<h4 class="text-center font-recoleta fw-bold pb-30 text-white">Full Width Dark</h4>
				<div class="box-layout pb-80">
					<div class="mixitUp-container">
			    		<div class="mix designer">
			    			<div class="team-block-one position-relative">
								<img src="{{ URL::asset('images/team/img_01.jpg') }}" alt="" class="team-img w-100">
			    		...
			    		<div class="mix dev designer">
			    			<div class="team-block-one position-relative">
								<img src="{{ URL::asset('images/team/img_02.jpg') }}" alt="" class="team-img w-100">
								<div class="overlay-bg d-flex align-items-end">
									<div class="hover-content tran3s">
			    		...
			    		<div class="mix support">
			    			<div class="team-block-one position-relative">
								<img src="{{ URL::asset('images/team/img_03.jpg') }}" alt="" class="team-img w-100">
								<div class="overlay-bg d-flex align-items-end">
									<div class="hover-content tran3s">
			    		...
			    		<div class="mix support dev">
			    			<div class="team-block-one position-relative">
								<img src="{{ URL::asset('images/team/img_04.jpg') }}" alt="" class="team-img w-100">
								<div class="overlay-bg d-flex align-items-end">
									<div class="hover-content tran3s">
			    		...
			    		<div class="mix dev">
			    			<div class="team-block-one position-relative">
								<img src="{{ URL::asset('images/team/img_12.jpg') }}" alt="" class="team-img w-100">
								<div class="overlay-bg d-flex align-items-end">
									<div class="hover-content tran3s">
										<h6 class="name">Rashed Kabi</h6>
										<div class="position">UI Designer</div>
										<ul class="social-icon d-flex style-none">
											<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
											<li><a href="#"><i class="fab fa-instagram"></i></a></li>
			    		...
			    		<div class="mix designer support">
			    			<div class="team-block-one position-relative">
								<img src="{{ URL::asset('images/team/img_13.jpg') }}" alt="" class="team-img w-100">
								<div class="overlay-bg d-flex align-items-end">
									<div class="hover-content tran3s">
										<h6 class="name">Rashed Kabi</h6>
										<div class="position">UI Designer</div>
			    		...
			    		<div class="mix designer support dev">
			    			<div class="team-block-one position-relative">
								<img src="{{ URL::asset('images/team/img_14.jpg') }}" alt="" class="team-img w-100">
								<div class="overlay-bg d-flex align-items-end">
									<div class="hover-content tran3s">
										<h6 class="name">Jubayer Hasan</h6>
										<div class="position">Developer</div>
			    		...
			    		<div class="mix designer support">
			    			<div class="team-block-one position-relative">
								<img src="{{ URL::asset('images/team/img_15.jpg') }}" alt="" class="team-img w-100">
								<div class="overlay-bg d-flex align-items-end">
									<div class="hover-content tran3s">
										<h6 class="name">Martin Jame</h6>
										<div class="position">Core Developer</div>
										<ul class="social-icon d-flex style-none">
											<li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
											<li><a href="#"><i class="fab fa-instagram"></i></a></li>
			...
			============================================== 
			-->
			<div class="team-section-three pt-150 lg-pt-120">
				<div class="container">
					<h4 class="text-center font-recoleta fw-bold pb-20">Vintage Style</h4>
					<div class="row">
			...
			=====================================================
			-->
			<div class="team-section-one mt-120 border-top pt-80 mb-100">
				<div class="container">
					<h4 class="text-center font-recoleta fw-bold">Slider Style</h4>
				</div> <!-- /.container -->
				...
				<div class="team_slider_one box-layout">
					...
					<div class="item">
						<div class="team-block-one position-relative">
							<img src="{{ URL::asset('images/team/img_05.jpg') }}" alt="" class="team-img w-100">
							<div class="overlay-bg d-flex align-items-end">
								<div class="hover-content tran3s">
