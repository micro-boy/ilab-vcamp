...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Service <span>Feature</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.content.ui-subscribe-form') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-three mt-160 lg-mt-120 mb-150 lg-mb-100">
				<div class="container">
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-twelve pt-130 pb-150 lg-pt-100 lg-pb-120">
				<div class="container">
					<div class="row">
						<div class="col-lg-6 col-md-8 col-sm-10 m-auto">
							<div class="title-style-five white-vr text-center pb-40 lg-pb-10">
								<h2 class="title">Our included service.</h2>
							</div>
						</div>
					</div>
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-three dark-bg mt-160 lg-mt-120 p0">
				<div class="container">
					<div class="row align-items-center mb-80 lg-mb-30 pt-100">
						<div class="col-lg-7 col-md-8 m-auto">
							<div class="title-style-nine white-vr text-center">
								<h2 class="title">We Offer Qulity Features</h2>
							</div>
						</div>
					</div>
