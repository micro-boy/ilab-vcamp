...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Subscribe <span>Form</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.content.ui-team') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			============================================== 
			-->
			<div class="subscribe-section-one pt-100 pb-100">
				<div class="container">
					<div class="row">
						<div class="col-lg-6">
							...
							<div class="subscribe-form-one">
								<form action="#">
									<input type="email" placeholder="Enter your email">
									<button class="ripple-btn">Join <img src="{{ URL::asset('images/icon/icon_92.svg') }}" alt="" class="ms-2 d-inline-block"></button>
								</form>
								<p>Already sign up? <a href="#">unsubscribe</a></p>
							</div>
						</div>
						...
						<div class="col-xl-5 col-lg-6 ms-auto">
							<div class="subscribe-form-two md-mt-40">
								<p>Join over <span>68,000</span> people getting our emails</p>
								<form action="#">
									<input type="email" placeholder="Enter your email">
									<button  class="ripple-btn">Sign Up</button>
								</form>
								<div class="info">We only send interesting and relevant emails.</div>
							</div> <!-- /.subscribe-form-two -->
						</div>
					</div>
				</div>
			</div> <!-- /.subscribe-section-one -->
			...
			<div class="box-layout">
				<div class="subscribe-section-two pt-120 pb-140 lg-pt-80 lg-pb-90">
					<div class="container">
						<div class="row">
							<div class="col-xxl-7 col-lg-8 col-md-10 m-auto">
								<div class="title-style-one text-center pb-50">
									<h2 class="title">Get update by <span>signup</span> Newsletter</h2>
								</div>
							</div>
						</div>
						<form action="#">
			...
			=====================================================
			-->
			<div class="box-layout mt-80 mb-80">
			...
			============================================== 
			-->
			<div class="box-layout mt-100 mb-100">
				<div class="subscribe-section-three pt-50 pb-50">
					<div class="container">
						<div class="row">
							<div class="col-xxl-11 m-auto">
								<div class="subscribe-area">
