...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">List <span>Item</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.basic.ui-menuV1') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			=====================================================
			-->
			<div class="vcamp-text-block-thirteen pt-130 lg-pt-100">
				<div class="container">
					<div class="row">
						<div class="col-lg-5">
						...
						<div class="col-xl-6 col-lg-7 ms-auto">
							<ul class="ui-list-item-one style-none">
								<li>Monthly reports on how your campaigns are performing</li>
								<li>Design custom ads and re-targeting campaigns</li>
								<li>Constantly innovating and testing new campaign ideas</li>
								<li>Manage and update your active campaigns</li>
							</ul>
						</div>
					</div>
				</div>
			...
			=====================================================
			-->
			<div class="vcamp-text-block-fourteen border-top mt-120 pt-200 pb-200 lg-mt-80 lg-pt-120 lg-pb-120">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 col-md-7 order-lg-last">
							<div class="text-wrapper ps-xxl-5">
								<div class="title-style-six">
									<div class="upper-title">Best Solution</div>
									<h2 class="title">Why you choose vCamp?</h2>
								</div>
								<p class="text-lg pt-40 pb-50 lg-pt-20 lg-pb-30">Things go wrong have We’ve understand.</p>
								<ul class="ui-list-item-two style-none">
						...
						<div class="col-lg-6 col-md-5">
							<div class="img-wrapper position-relative d-inline-block sm-mt-40">
								<img src="{{ URL::asset('images/media/img_69.png') }}" alt="">
							</div>
						</div>
					</div>
				</div>
			</div> <!-- /.vcamp-text-block-fourteen -->
			...
			=====================================================
			-->
			<div class="vcamp-text-block-fifteen dark-bg pt-150 pb-150 lg-pt-100 lg-pb-100">
				<div class="container">
					<div class="row">
			...
			<div class="vcamp-text-block-thirteen pt-150 mb-130 lg-pt-100 lg-mb-80">
				<div class="container">
					<div class="img-media mb-80 lg-mb-40"><img src="{{ URL::asset('images/media/img_89.jpg') }}" alt="" class="w-100"></div>
					<div class="row">
						<div class="col-lg-6">
							<ul class="ui-list-item-one style-none">
								<li>Monthly reports on how your campaigns are performing</li>
								<li>Constantly innovating and testing new campaign ideas</li>
								<li>Design custom element with love & care.</li>
							</ul>
						</div>
						<div class="col-lg-6">
							<ul class="ui-list-item-one style-none">
								<li>Manage and update your active campaigns</li>
								<li>Amazing communication & best service experience</li>
								<li>Smooth layout & support</li>
							</ul>
						</div>
					</div>
				</div>
			...
			============================================== 
			-->
			<div class="vcamp-text-block-twelve dark-bg pt-100 pb-100">
				<div class="container">
					<div class="row">
						<div class="col-xxl-5 col-xl-6 col-lg-7">
							<div class="text-wrapper">
								<div class="title-style-nine white-vr pb-45 lg-pb-30">
								...
								<a href="{{ url('pages.support.contactV2') }}" class="theme-btn-twelve outline mt-45 lg-mt-30">Consult with an exprt now!</a>
							</div> <!-- /.text-wrapper -->
						</div>
					</div>
				</div>
