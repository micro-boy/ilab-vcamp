	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title"><span>Footer</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.essential.ui-form') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="vcamp-footer-one box-layout">
				<h4 class="text-center font-recoleta fw-bold pb-30 pt-60">Default Footer</h4>
			...
			=====================================================
			-->
			<h4 class="text-center font-recoleta fw-bold border-top pb-30 pt-80">Footer Minimal: Dark</h4>
			<div class="vcamp-footer-three dark-bg">
				<div class="container">
					<div class="d-lg-flex align-items-center justify-content-between">
						<div class="logo text-center"><a href="{{ url('home.index') }}"><img src="{{ URL::asset('images/logo/vCamp_02.png') }}" alt="" style="width:127px"></a></div>
			...
			=====================================================
			-->
			<h4 class="text-center font-recoleta fw-bold pt-80">Footer Classic: Light</h4>
			...
			=====================================================
			-->
			<h4 class="text-center font-recoleta fw-bold pb-30 pt-80">Default Footer: Dark</h4>
			<div class="vcamp-footer-one dark-bg p0">
				<div class="clearfix">
					<div class="container">
						<div class="row">
							<div class="col-xxl-11 m-auto">
								<div class="subscribe-area pt-100">
									<div class="row align-items-center">
										<div class="col-md-6">
			...
			=====================================================
			-->
			<h4 class="text-center font-recoleta fw-bold border-top pb-30 pt-80">Footer Minimal: Light</h4>
			<div class="vcamp-footer-four border-top border-bottom">
				<div class="container">
					<div class="inner-content">
						<div class="row">
			...
			=====================================================
			-->
			<h4 class="text-center font-recoleta fw-bold pb-30 pt-80">Footer Classic: Dark</h4>
