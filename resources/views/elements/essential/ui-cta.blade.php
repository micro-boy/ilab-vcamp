	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Call To <span>Action</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.essential.ui-faq') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="fancy-banner-eight pt-120 pb-120 lg-pt-100 lg-pb-100">
				<div class="container">
					<div class="row">
						<div class="col-xxl-8 col-xl-9 col-lg-7 m-auto">
							<div class="title-style-one text-center pe-xxl-2 ps-xxl-2">
								<h2 class="title">love our product? <span>Save $20</span> by grab it today.</h2>
								<p class="text-lg pt-35 pb-50 lg-pt-30 lg-pb-30">Try it risk free — we don’t charge cancellation fees.</p>
							</div>
						</div>
					</div>
					<form action="#" class="m-auto">
						<input type="email" placeholder="vcamp@demo.gov">
			...
			============================================== 
			-->
			<div class="vcamp-text-block-one mt-150 md-mt-80 mb-120 lg-mb-80">
				<div class="container">
					<div class="row align-items-center">
			...
			============================================== 
			-->
			<div class="shop-new-collection-section mt-150 lg-mt-100">
