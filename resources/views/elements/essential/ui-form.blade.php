...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Useful <span>Form</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.essential.ui-gallery') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			============================================== 
			-->
			<div class="form-section-one pt-100 pb-120">
				<div class="container">
					<div class="title-style-four text-center">
						<h2 class="title">Sign up & Start Rolling!</h2>
						<p class="text-lg pt-30 lg-pt-20">Sign up right now and get 30% instant</p>
					</div>
					<form action="#" class="form-style-five mt-70 lg-mt-50">
						<div class="row">
								...
								<div class="row align-items-end">
									<div class="col-lg-5 col-md-6">
										<div class="input-group-meta position-relative mb-25">
											...
											<img src="{{ URL::asset('images/icon/icon_93.svg') }}" alt="" class="icon-placeholder">
										</div>
									</div>
									<div class="col-lg-5 col-md-6">
										<div class="input-group-meta position-relative mb-25">
											...
											<img src="{{ URL::asset('images/icon/icon_94.svg') }}" alt="" class="icon-placeholder">
										</div>
									</div>
									<div class="col-lg-2">
										<button class="theme-btn-thirteen w-100 mb-25">Sign In</button>
									</div>
									<div class="col-12">
										<div class="agreement-checkbox text-center mt-20">
			...
			============================================== 
			-->
			<div class="form-section-two user-data-page">
				<div class="container h-100">
					<div class="row h-100">
						<div class="col-xxl-6 col-lg-7 col-md-9 m-auto">
							<div class="form-wrapper">
								<h2 class="font-recoleta">Hi <span>buddy</span>, welcome <br> Back!</h2>
								<p class="header-info pt-20 pb-40 lg-pt-10 lg-pb-10">Still don't have an account? <a href="{{ url('shop.sign-up') }}">Sign up</a></p>
								<form action="#" class="user-data-form">
									<div class="row">
										...
										<div class="col-12">
											<button class="theme-btn-one w-100 mt-30">Login</button>
										</div>
									</div>
								</form>
							</div> <!-- /.form-wrapper -->
			...
			============================================== 
			-->
			<div class="form-section-three light-bg pt-100 pb-170 lg-pb-100">
				<div class="container">
					<div class="row">
						<div class="col-xxl-6 col-xl-7 col-lg-6 m-auto">
							<div class="title-style-two text-center pb-50">
								<h2 class="title"><span>Register</span> Now & Start Rolling!</h2>
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-xxl-10 col-xl-11 m-auto">
							<div class="form-style-one with-border m0">
								<p class="text-lg pb-50 lg-pb-20 text-center">Still don't have an account? <a href="{{ url('shop.sign-up') }}" class="text-dark text-decoration-underline">Sign up</a></p>
								<form action="#">
									<div class="row">
										<div class="col-md-6">
										...
										<div class="col-12">
											<div class="agreement-checkbox">
												<div class="d-inline-block">
													<input type="checkbox" id="agree_to_policy2">
													<label for="agree_to_policy2">By clicking "SIGN UP" I agree to the Terms and Conditions and Privacy Policy.</label>
												</div>
											</div>
										</div>
										<div class="col-12"><button class="theme-btn-one ripple-btn w-100 mt-30">SIGNUP</button></div>
									</div>
								</form>
							...
							<div class="col-12">
								<div class="agreement-checkbox d-flex justify-content-between align-items-center">
									<div>
										...
										<label for="remember2">Keep me logged in</label>
									</div>
									<a href="#">Forget Password?</a>
								</div> <!-- /.agreement-checkbox -->
							</div>
