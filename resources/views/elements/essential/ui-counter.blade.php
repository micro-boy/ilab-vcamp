...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title"><span>Counter</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.essential.ui-cta') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			=====================================================
			-->
			<div class="counter-section-four pt-100">
				<div class="container">
					<div class="row">
						<div class="col-md-4 col-sm-6">
							<div class="counter-block-four mb-45">
								<div class="d-flex">
									<div class="icon"><img src="{{ URL::asset('images/icon/icon_98.svg') }}" alt=""></div>
									<div class="text">
										<div class="main-count font-recoleta"><span class="counter">20</span>million</div>
										<p class="theme-mb-0">3,280 avg rating</p>
									</div>
								</div>
							</div> <!-- /.counter-block-four -->
						</div>
						<div class="col-md-4 col-sm-6">
							<div class="counter-block-four mb-45">
								<div class="d-flex">
									<div class="icon"><img src="{{ URL::asset('images/icon/icon_99.svg') }}" alt=""></div>
									<div class="text">
						...
						<div class="col-md-4 col-sm-6">
							<div class="counter-block-four mb-45">
								<div class="d-flex">
									<div class="icon"><img src="{{ URL::asset('images/icon/icon_100.svg') }}" alt=""></div>
									<div class="text">
										<div class="main-count font-recoleta"><span class="counter">3000</span>+</div>
				...
				<div class="box-layout">
					<div class="row gx-0">
						...
						<div class="col-lg-3 col-sm-6">
							<div class="counter-block-five text-center">
								<div class="d-flex align-items-end justify-content-center icon">
									<img src="{{ URL::asset('images/icon/icon_98.svg') }}" alt="">
								</div>
								<div class="main-count font-recoleta"><span class="counter">20</span>million</div>
								<p class="theme-mb-0">3,280 avg rating</p>
							</div> <!-- /.counter-block-five -->
						...
						<div class="col-lg-3 col-sm-6">
							<div class="counter-block-five text-center">
								<div class="d-flex align-items-end justify-content-center icon">
									<img src="{{ URL::asset('images/icon/icon_101.svg') }}" alt="">
								</div>
								<div class="main-count font-recoleta"><span class="counter">50</span>k+</div>
								<p class="theme-mb-0">Contact Profile</p>
							</div> <!-- /.counter-block-five -->
						...
						<div class="col-lg-3 col-sm-6">
							<div class="counter-block-five text-center">
								<div class="d-flex align-items-end justify-content-center icon">
									<img src="{{ URL::asset('images/icon/icon_100.svg') }}" alt="">
								</div>
								<div class="main-count font-recoleta"><span class="counter">3000</span>+</div>
								<p class="theme-mb-0">Using vCamp</p>
							</div> <!-- /.counter-block-five -->
			...
			=====================================================
			-->
			<div class="counter-section-three border-bottom pt-120 pb-60 lg-pt-80 lg-pb-30">
				<div class="container">
					<div class="row">
						<div class="col-md-4">
			...
			=====================================================
			-->
			<div class="counter-section-one mt-120 md-mt-80">
			...
			=====================================================
			-->
			<div class="feedback-section-seven mt-150 lg-mt-110 mb-100">
				<div class="container">
					<div class="row">
