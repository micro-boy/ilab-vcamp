...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Feature <span>Block</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.essential.ui-footer') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="vcamp-text-block-one mt-200 lg-mt-120">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-xxl-5 col-lg-6 order-lg-last">
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-eleven border-top border-bottom mt-100 pt-100 pb-100">
				<div class="container">
					<div class="row">
						<div class="col-xxl-8 col-xl-10 col-lg-7 col-md-10 m-auto">
							<div class="title-style-nine text-center">
								<h2 class="title">We Turn Your Ideas into Real Businesses</h2>
								<p class="text-lg pt-30 lg-pt-20">We turn bold ideas into market-leading companies.</p>
							</div> <!-- /.title-style-nine -->
						</div>
					</div>
					<div class="img-block mt-55 mb-30 lg-mt-30 lg-mb-10">
						<img src="{{ URL::asset('images/media/img_75.jpg') }}" alt="">
					</div>

					<div class="row gx-xl-5 justify-content-center">
						<div class="col-lg-4 col-sm-6 mt-50">
							<div class="card-style-eleven text-center">
								<div class="icon d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/icon/icon_89.svg') }}" alt=""></div>
								<h4>Friendly Interface</h4>
								<p class="pe-xxl-4 ps-xxl-4">quis nostrud exercit ullamo ea laboris nisi ut aliqui duis aut iru. </p>
							</div> <!-- /.card-style-eleven -->
						</div>
						<div class="col-lg-4 col-sm-6 mt-50">
							<div class="card-style-eleven text-center">
								<div class="icon d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/icon/icon_90.svg') }}" alt=""></div>
								<h4>Quality Supprot</h4>
								<p class="pe-xxl-4 ps-xxl-4">quis nostrud exercit ullamo labo nisiali om dolorq. Duis aut iru qui nostrud exercit ullamo  </p>
							</div> <!-- /.card-style-eleven -->
						</div>
						<div class="col-lg-4 col-sm-6 mt-50">
							<div class="card-style-eleven text-center">
								<div class="icon d-flex align-items-center justify-content-center"><img src="{{ URL::asset('images/icon/icon_91.svg') }}" alt=""></div>
								<h4>Great Pricing</h4>
								<p class="pe-xxl-4 ps-xxl-4">quis nostrud exercit ullamo ea laboris nisi ut aliqui duis aut iru. </p>
							</div> <!-- /.card-style-eleven -->
						</div>
			...
			</div> <!-- /.vcamp-feature-section-eleven -->
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-three mt-150 lg-mt-80">
				<div class="container">
					<div class="row">
						<div class="col-xl-4">
							<div class="service-title mt-95 lg-mt-40 lg-mb-40">Development</div>
						</div>
					...
					<div class="row">
						<div class="col-xl-4">
							<div class="service-title mt-95 lg-mt-40 lg-mb-40">Marketing</div>
						</div>
						<div class="col-xl-4 col-sm-6">
							<div class="card-style-three mb-100 lg-mb-50">
			...
			============================================== 
			-->
			<div class="vcamp-feature-section-nine pt-150 lg-pt-120 border-top">
				<div class="container">
			...
			============================================== 
			-->
			<div class="vcamp-text-block-one border-top mt-150 lg-mt-120 pt-120 pb-120 lg-pb-80">
				<div class="container">
					<div class="row align-items-center">
						<div class="col-xxl-6 col-xl-7 col-lg-6 order-lg-last">
							<div class="text-wrapper ps-xxl-5 pt-0 md-pb-40">
								<div class="title-style-one">
									<h2 class="title">We’ve been helping <span>cutomer</span> globally.</h2>
								</div>
								<p class="meta-info-text text-lg">So how does it work? Let’s check our Getting Started tutorial pre-made templates.</p>
								<a href="{{ url('pages.essential.about-usV2') }}" class="theme-btn-two">Explore all features</a>
							</div>
						</div>
						<div class="col-xxl-6 col-xl-5 col-lg-6">
							<div class="video-img-box">
								<img src="{{ URL::asset('images/media/img_76.jpg') }}" alt="">
								<a class="fancybox video-icon d-flex align-items-center justify-content-center" data-fancybox="" href="https://www.youtube.com/embed/aXFSJTjVjw0" tabindex="0">
									<img src="{{ URL::asset('images/icon/icon_41.svg') }}" alt="">
								</a>
							</div> <!-- /.video-img-box -->
