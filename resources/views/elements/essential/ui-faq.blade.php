...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title"><span>FAQs</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.essential.ui-feature-block') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="accordion-item">
									  	...
									  	<div class="accordion-item">
										    <div class="accordion-header" id="headingSix">
										      	<button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseSix" >
										        	What about invesment plan & process?
										      	</button>
										    </div>
									  	...
									  	<div class="accordion-item">
										    ...
										    <div id="collapseSeven" class="accordion-collapse collapse" data-bs-parent="#accordionThree">
										      	<div class="accordion-body">
										        	<p>Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.</p>
										    	</div>
										    </div>
									...
									<div class="col-lg-6">
										<div class="accordion-item">
										    <div class="accordion-header" id="headingThree">
										   		<button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree">
										        	How can i get help by Vcamp & the support?
										      	</button>
										    </div>
										...
										<div class="accordion-item">
										    <div class="accordion-header" id="headingFour">
										   		<button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFour">
										        	How maintance user dashboard work?
										      	</button>
										    </div>
										...
										<div class="accordion-item">
										    <div class="accordion-header" id="headingFive">
										   		<button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFive">
										        	How can i make profit by sign up & build wordPress theme?
										      	</button>
										    </div>
										    <div id="collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionThree">
										    	<div class="accordion-body">
										        	<p>Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.</p>
										    	</div>
										    </div>
										...
										<div class="accordion-item">
										    ...
										    <div id="collapseEight" class="accordion-collapse collapse" data-bs-parent="#accordionThree">
										    	<div class="accordion-body">
										        	<p>Lorem ipsum dolor sit amet, vix an natum labitur eleifd, mel am laoreet menandri. Ei justo complectitur duo. Ei mundi solet utos soletu possit quo. Sea cu justo laudem.</p>
										    	</div>
										    </div>
						...
						<div class="col-xxl-5 col-lg-6">
							<div class="text-wrapper">
								<div class="title-style-one white-vr">
									<div class="upper-title">FAQ’s</div>
									<h2 class="title">Any <span>questions?</span> Look here.</h2>
								</div>
								<a href="{{ url('pages.support.contactV3') }}" class="mt-30 theme-btn-four">Contact us</a>
							</div> <!-- /.text-wrapper -->
						</div>
							...
							<div class="accordion accordion-style-three lg-mt-60" id="accordionTwo">
								<div class="accordion-item">
								    ...
								    <div id="collapseOneA" class="accordion-collapse collapse" data-bs-parent="#accordionTwo">
								    	<div class="accordion-body">
								        	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do ruiter eiusmod tempor incididunt ut labore et dolore magna aliqua. eli enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip visual sed.</p>
								    	</div>
								    </div>
							  	</div>
							  	<div class="accordion-item">
								    ...
								    <div id="collapseTwoB" class="accordion-collapse collapse" data-bs-parent="#accordionTwo">
								      	<div class="accordion-body">
								        	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do ruiter eiusmod tempor incididunt ut labore et dolore magna aliqua. eli enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip visual sed.</p>
								    	</div>
								    </div>
							  	...
							  	<div class="accordion-item">
								    <div class="accordion-header" id="headingThreeC">
								   		<button class="accordion-button" data-bs-toggle="collapse" data-bs-target="#collapseThreeC">
								        	What does First Round look for in an idea?
								      	</button>
								    </div>
								    <div id="collapseThreeC" class="accordion-collapse collapse show" data-bs-parent="#accordionTwo">
								    	<div class="accordion-body">
								        	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do ruiter eiusmod tempor incididunt ut labore et dolore magna aliqua. eli enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip visual sed.</p>
								    	</div>
								    </div>
								...
								<div class="accordion-item">
								    <div class="accordion-header" id="headingFourD">
								   		<button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFourD">
								        	What do you look for in a founding team?
								      	</button>
								    </div>
								    <div id="collapseFourD" class="accordion-collapse collapse" data-bs-parent="#accordionTwo">
								    	<div class="accordion-body">
								        	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do ruiter eiusmod tempor incididunt ut labore et dolore magna aliqua. eli enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip visual sed.</p>
								    	</div>
								    </div>
								...
								<div class="accordion-item">
								    <div class="accordion-header" id="headingFiveE">
								   		<button class="accordion-button collapsed" data-bs-toggle="collapse" data-bs-target="#collapseFiveE">
								        	Do you recommend Pay as you go or Pre pay?
								      	</button>
								    </div>
								    <div id="collapseFiveE" class="accordion-collapse collapse" data-bs-parent="#accordionTwo">
								    	<div class="accordion-body">
								        	<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do ruiter eiusmod tempor incididunt ut labore et dolore magna aliqua. eli enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip visual sed.</p>
								    	</div>
								    </div>
			...
			=====================================================
			-->
			<div class="faq-section-four mt-120 lg-mt-80">
				<div class="container">
					<div class="title-style-one text-center pb-60">
						<h2 class="title pb-5">Question & Answer</h2>
						<p>Browse help topics or use the search bar</p>
					</div>
					<div class="row">
						<div class="col-xxl-10 col-xl-11 m-auto">
							<form action="#" class="faq-search-filter radius mb-100 lg-mb-60">
								<input type="text" placeholder="Search here..">
								<button class="tran3s"><i class="bi bi-search"></i></button>
							</form>
						</div>
						...
						<div class="wrapper">
							<div class="row gx-xl-5">
								<div class="col-lg-4 col-md-6">
									<div class="faq-block">
										<h4>How can i get help by vCamp & get support?</h4>
										<p>Certainly from my perspective been a great success withWP giving us that enterprises level assured quality.</p>
									</div> <!-- /.faq-block -->
									<div class="faq-block">
										<h4>How do you weigh different criteria in your process?</h4>
										<p>Lorem ipsum dolor sit amet, consecte adipiscin elit, sed do eiusmod.</p>
										<p>labore et dolore magna aliqua.Lorem ipsum dolor sit amet, consecte adipiscin elit, sed do eiusmod tempor incididunt ut</p>
									</div> <!-- /.faq-block -->
								</div>
								<div class="col-lg-4 col-md-6">
									<div class="faq-block">
										<h4>What do you look for in a founding team?</h4>
										<p>Lorem ipsum dolor sit amet, consecte adipiscin elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim minim veniam, quis nostrud exercitation ullamco laboris consequat. </p>
										<p>Duis aute irure dolor in reprehend volupta velit esse cillum dolore eu. </p>
									</div> <!-- /.faq-block -->
									<div class="faq-block">
										<h4>How to close account?</h4>
										<p>Lorem ipsum dolor sit amet, consecte adipiscin elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
									</div> <!-- /.faq-block -->
								</div>
								<div class="col-lg-4 col-md-6">
									<div class="faq-block">
										<h4>How to Open account?</h4>
										<p>Lorem ipsum dolor sit amet, consecte adipiscin elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim minim veniam, quis nostrud exercitation.</p>
									</div> <!-- /.faq-block -->
									<div class="faq-block">
										<h4>What do you look for in a founding team?</h4>
										<p>Lorem ipsum dolor sit amet, consecte adipiscin elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim minim veniam, quis nostrud exercitation ullamco laboris consequat. </p>
							...
							<div class="text-center mt-50 lg-mt-30"><a href="#" class="theme-btn-one">Load More</a></div>
						</div> <!-- /.wrapper -->
					</div> <!-- /.bg-wrapper -->
				</div> <!-- /.box-layout -->
