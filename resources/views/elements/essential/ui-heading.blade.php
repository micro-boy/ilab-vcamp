...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						...
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title"><span>Heading</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.content.ui-hero-section') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="pt-100">
				<div class="container">
					<div class="title-style-one text-center">
						...
						<h2 class="title">Vcamp <span>heading</span> One</h2>
					</div>
				</div>
			</div>
			...
			=====================================================
			-->
			<div class="pt-100 mt-100 border-top">
				<div class="container">
					<div class="title-style-two text-center">
						<h2 class="title">Vcamp <span>heading</span> Two</h2>
					</div>
				</div>
			</div>
			...
			<div class="pt-100 mt-100 border-top">
				<div class="container">
					<div class="title-style-three text-center">
						<h2 class="title">Vcamp <span>heading</span> Three</h2>
					</div>
				</div>
			</div>
			...
			<div class="pt-100 mt-100 border-top">
				<div class="container">
					<div class="title-style-four text-center">
						<h2 class="title">Vcamp heading Four</h2>
					</div>
				</div>
			</div>
			...
			<div class="pt-100 mt-100 border-top">
				<div class="container">
					<div class="title-style-five text-center">
						<div class="upper-title">What we do</div>
						<h2 class="title">Vcamp heading Five</h2>
					</div>
				</div>
			</div>
			...
			<div class="pt-100 mt-100 border-top">
				<div class="container">
					<div class="title-style-six text-center">
						<div class="upper-title">What we do</div>
						<h2 class="title">Vcamp heading Six</h2>
					</div>
				</div>
			</div>
			...
			<div class="pt-100 mt-100 border-top">
				<div class="container">
					<div class="title-style-seven text-center">
						<h2 class="title">Vcamp <span>heading <img src="{{ URL::asset('images/shape/shape_54.svg') }}" alt=""></span> Seven</h2>
					</div>
				</div>
			</div>
			...
			<div class="pt-100 mt-100 border-top">
				<div class="container">
					<div class="title-style-eight text-center">
						<h2 class="title">Vcamp heading Eight</h2>
					</div>
				</div>
			</div>
			...
			<div class="pt-100 mt-100 border-top">
				<div class="container">
					<div class="title-style-nine text-center">
						<div class="upper-title">What we do</div>
						<h2 class="title">Vcamp heading Nine</h2>
					</div>
				</div>
			</div>
			...
			=====================================================
			-->
			<div class="pt-100 mt-100 mb-100 border-top">
				<div class="container">
					<div class="title-style-ten text-center">
						<h2 class="title">Vcamp heading Ten</h2>
					</div>
				</div>
			</div>
