...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
			...
			============================================== 
			-->
			<div class="vcamp-text-block-one pt-180 md-pt-120 pb-80 border-bottom">
				<div class="container">
					<div class="row">
						<div class="col-xxl-7 col-lg-8 m-auto">
							<div class="text-wrapper text-center ps-0">
								<div class="title-style-two">
									<h3 class="title">Creative <span>Portfolio</span></h3>
								</div>
								<p class="meta-info-text text-lg">If you have fancy for building up your online business, you must adopt a website.</p>
								<a href="{{ url('elements.headers.ui-headerV1') }}" class="theme-btn-one ripple-btn">Next Element <img src="{{ URL::asset('images/icon/icon_03.svg') }}" alt=""></a>
							</div>
						</div>
					</div>
				</div>
			...
			=====================================================
			-->
			<h4 class="text-center font-recoleta fw-bold pt-120">Creative Dark Slider Style</h4>
			<div class="case-study-six dark-bg mt-80 ms-auto me-auto">
				<div class="container">
					<div class="row align-items-center justify-content-between">
						<div class="col-md-6 col-sm-8">
							<div class="title-style-five white-vr text-center text-sm-start xs-pb-20">
						...
						<div class="col-lg-5 col-md-6 col-sm-4 d-flex justify-content-center justify-content-sm-end">
							<ul class="slider-arrows d-flex style-none">
								<li class="prev_case2 ripple-btn slick-arrow" style=""><i class="bi bi-arrow-left"></i></li>
								<li class="next_case2 ripple-btn slick-arrow" style=""><i class="bi bi-arrow-right"></i></li>
							</ul>
						</div>
					</div>
				</div>
				<div class="slider-wrapper pt-80 lg-pt-50">
					<div class="case_slider_two">
						<div class="item">
							<div class="case-block-five">
								<div class="img-holder"><img src="{{ URL::asset('images/media/img_77.jpg') }}" alt="" class="w-100"></div>
								<div class="text">
									<div class="tag">User Interface</div>
									<h4><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">vCamp- Landing Page Template for your Startup</a></h4>
								</div>
							</div> <!-- /.case-block-five -->
						</div>
						<div class="item">
							<div class="case-block-five">
								<div class="img-holder"><img src="{{ URL::asset('images/media/img_78.jpg') }}" alt="" class="w-100"></div>
								<div class="text">
									<div class="tag">Web developemnt</div>
									<h4><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">vCamp- Landing Page Template for your Startup</a></h4>
								</div>
							</div> <!-- /.case-block-five -->
						</div>
						<div class="item">
							<div class="case-block-five">
								<div class="img-holder"><img src="{{ URL::asset('images/media/img_79.jpg') }}" alt="" class="w-100"></div>
								<div class="text">
									<div class="tag">Social Marketing</div>
									<h4><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">vCamp- Landing Page Template for your Startup</a></h4>
								</div>
							</div> <!-- /.case-block-five -->
						</div>
			...
			============================================== 
			-->
			<!-- NOTE: You have to link the 'isotope.pkgd.min.js' in order use this style  -->
			<div class="case-study-seven pb-60">
				<h4 class="text-center font-recoleta fw-bold pt-120 pb-80">Masonry Style</h4>
				<div class="container">
					<ul class="style-none text-center isotop-menu-wrapper control-nav-two pb-90 lg-pb-60">
				...
				<div class="box-layout">
					<div id="isotop-gallery-wrapper">
						...
						<div class="isotop-item plugin">
							<div class="case-block-six">
								<div class="img-box"><img src="{{ URL::asset('images/media/img_80.jpg') }}" alt=""></div>
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">Lonely <span>Steve</span></a></h4>
										<p>vCamp- Landing Page Template</p>
										<a class="fancybox position-relative zoom" data-fancybox="" href="images/media/img_80.jpg" tabindex="0"><i class="bi bi-arrows-angle-expand"></i></a>
									</div>
								</div> <!-- /.hover-valina -->
							</div> <!-- /.case-block-six -->
						</div> <!-- /.isotop-item -->
						<div class="isotop-item plugin">
							<div class="case-block-six">
								<div class="img-box"><img src="{{ URL::asset('images/media/img_81.jpg') }}" alt=""></div>
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">Lonely <span>Steve</span></a></h4>
										<p>vCamp- Landing Page Template</p>
										<a class="fancybox position-relative zoom" data-fancybox="" href="images/media/img_81.jpg" tabindex="0"><i class="bi bi-arrows-angle-expand"></i></a>
									</div>
								</div> <!-- /.hover-valina -->
							</div> <!-- /.case-block-six -->
						</div> <!-- /.isotop-item -->
						<div class="isotop-item dev custom">
							<div class="case-block-six">
								<div class="img-box"><img src="{{ URL::asset('images/media/img_82.jpg') }}" alt=""></div>
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">Lonely <span>Steve</span></a></h4>
										<p>vCamp- Landing Page Template</p>
										<a class="fancybox position-relative zoom" data-fancybox="" href="images/media/img_82.jpg" tabindex="0"><i class="bi bi-arrows-angle-expand"></i></a>
									</div>
								</div> <!-- /.hover-valina -->
							</div> <!-- /.case-block-six -->
						</div> <!-- /.isotop-item -->
						<div class="isotop-item custom">
							<div class="case-block-six">
								<div class="img-box"><img src="{{ URL::asset('images/media/img_84.jpg') }}" alt=""></div>
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">Lonely <span>Steve</span></a></h4>
										<p>vCamp- Landing Page Template</p>
										<a class="fancybox position-relative zoom" data-fancybox="" href="images/media/img_84.jpg" tabindex="0"><i class="bi bi-arrows-angle-expand"></i></a>
									</div>
								</div> <!-- /.hover-valina -->
							</div> <!-- /.case-block-six -->
						</div> <!-- /.isotop-item -->
						<div class="isotop-item dev">
							<div class="case-block-six">
								<div class="img-box"><img src="{{ URL::asset('images/media/img_83.jpg') }}" alt=""></div>
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">Lonely <span>Steve</span></a></h4>
										<p>vCamp- Landing Page Template</p>
										<a class="fancybox position-relative zoom" data-fancybox="" href="images/media/img_83.jpg" tabindex="0"><i class="bi bi-arrows-angle-expand"></i></a>
									</div>
								</div> <!-- /.hover-valina -->
							</div> <!-- /.case-block-six -->
						</div> <!-- /.isotop-item -->
						<div class="isotop-item dev custom">
							<div class="case-block-six">
								<div class="img-box"><img src="{{ URL::asset('images/media/img_87.jpg') }}" alt=""></div>
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">Lonely <span>Steve</span></a></h4>
										<p>vCamp- Landing Page Template</p>
										<a class="fancybox position-relative zoom" data-fancybox="" href="images/media/img_87.jpg" tabindex="0"><i class="bi bi-arrows-angle-expand"></i></a>
									</div>
								</div> <!-- /.hover-valina -->
							</div> <!-- /.case-block-six -->
						</div> <!-- /.isotop-item -->
						<div class="isotop-item plugin">
							<div class="case-block-six">
								<div class="img-box"><img src="{{ URL::asset('images/media/img_86.jpg') }}" alt=""></div>
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">Lonely <span>Steve</span></a></h4>
										<p>vCamp- Landing Page Template</p>
										<a class="fancybox position-relative zoom" data-fancybox="" href="images/media/img_86.jpg" tabindex="0"><i class="bi bi-arrows-angle-expand"></i></a>
									</div>
								</div> <!-- /.hover-valina -->
							</div> <!-- /.case-block-six -->
						</div> <!-- /.isotop-item -->
						<div class="isotop-item plugin custom">
							<div class="case-block-six">
								<div class="img-box"><img src="{{ URL::asset('images/media/img_85.jpg') }}" alt=""></div>
								<div class="hover-valina">
									<div>
										<h4 class="title font-recoleta"><a href="{{ url('portfolio.single_portfolio.portfolio-detailsV2') }}">Lonely <span>Steve</span></a></h4>
										<p>vCamp- Landing Page Template</p>
										<a class="fancybox position-relative zoom" data-fancybox="" href="images/media/img_85.jpg" tabindex="0"><i class="bi bi-arrows-angle-expand"></i></a>
									</div>
								</div> <!-- /.hover-valina -->
							</div> <!-- /.case-block-six -->
						</div> <!-- /.isotop-item -->
			...
			=====================================================
			-->
			<div class="feedback-section-five border-bottom mt-100 pb-60">
				<h4 class="text-center font-recoleta fw-bold">Basic Slider Style</h4>
				<div class="inner-content">
			...
			=====================================================
			-->
			<h4 class="text-center font-recoleta fw-bold pt-100">Creative Slider Style</h4>
			<div class="feedback-section-three dark-bg mt-80">
			...
			=====================================================
			-->
			<div class="case-study-two mt-150 lg-mt-120 mb-100">
				<div class="container">
					<h4 class="text-center font-recoleta fw-bold">Basic Grid Style</h4>
